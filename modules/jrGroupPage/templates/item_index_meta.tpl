...
<meta property="og:title" content="Group Page - {$item.profile_name|jrCore_entity_string}"/>
...
{else}
<meta property="og:image" content="{$jamroom_url}/{jrCore_module_url module="jrImage"}/img/module/jrGroupPage/facebook_shared_icon.png"/>
{/if}
