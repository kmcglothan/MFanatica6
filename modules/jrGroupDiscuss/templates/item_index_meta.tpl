...
<meta property="og:title" content="Group Discuss - {$item.profile_name|jrCore_entity_string}"/>
...
{else}
<meta property="og:image" content="{$jamroom_url}/{jrCore_module_url module="jrImage"}/img/module/jrGroupDiscuss/facebook_shared_icon.png"/>
{/if}
