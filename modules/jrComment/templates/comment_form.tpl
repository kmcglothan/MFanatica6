...
<div id="{$jrComment.unique_id}_comments" class="comment_page_section">
    ...
    {if $jrComment.pagebreak > 0}
        {jrCore_list module="jrComment" search1="comment_item_id = `$jrComment.item_id`" search2="comment_module = `$jrComment.module`" order_by="_item_id `$dir`" profile_owner_id=$profile_owner_id pagebreak=$_conf.jrComment_pagebreak page=1 pager=true pager_template="comment_pager.tpl"}
    {else}
        {jrCore_list module="jrComment" search1="comment_item_id = `$jrComment.item_id`" search2="comment_module = `$jrComment.module`" order_by="_item_id `$dir`" limit="500" profile_owner_id=$profile_owner_id}
    {/if}
