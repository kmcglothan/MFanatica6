                    ...
                    {if isset($views)}
                        <table class="page_table" style="margin-bottom:0">
                            <tr>
                                ...
                                <th class="page_table_header" style="width:38%">User</th>
                                <th class="page_table_header" style="width:40%">Email</th>
                                <th class="page_table_header" style="width:20%">When</th>
                            </tr>
                        </table>
                        <div id="cp-display-area">
                            <table class="page_table">
                                {foreach $views as $_u}
                                    ...
                                    <td class="page_table_cell" style="width:38%">
                                    ...
                                    <td class="page_table_cell center" style="width:20%">{$_u.t_time|jrCore_format_time:false:"relative"}</td>
                                    </tr>
                                {/foreach}
                            </table>
                        </div>
                    {else}
                        <div class="p20 center">No Users have Viewed the email</div>
                    {/if}
                </div>
            </div>
        </div>
