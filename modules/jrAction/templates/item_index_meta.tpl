...
<meta property="og:title" content="Timeline - {$item.profile_name|jrCore_entity_string}"/>
<meta property="og:description" content="Check out the full timeline here"/>
...
{else}
<meta property="og:image" content="{$jamroom_url}/{jrCore_module_url module="jrImage"}/img/module/jrAction/facebook_shared_icon.png"/>
{/if}
...
<meta name="twitter:description" content="Check out the full timeline here"/>
{if isset($item.profile_image_size) && $item.profile_image_size > 100}
