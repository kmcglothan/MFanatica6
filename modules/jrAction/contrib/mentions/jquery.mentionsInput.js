...
(function ($, _, undefined) {
  ...
  var MentionsInput = function (input) {
    ...
    function initTextarea() {
      ...
      elmWrapperBox = $(settings.templates.wrapper({ 'defaultclass' : defaultSettings.defaultClass }));
    ...
    function addMention(value, id, type) {
      ...
      var c = ' ' + getInputBoxValue() + ' ';
      var r = new RegExp(' ' + settings.triggerChar + currentDataQuery + ' ', 'gi');
      var u = $.trim(c.replace(r, ' ' + value + ' '));
