...
<rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
    <channel>
        <title>{$_conf.jrCore_system_name} - Audio</title>
        <description>A feed of the combined audio items</description>
        <link>{$jamroom_url}/{jrCore_module_url module="jrCombinedAudio"}</link>
