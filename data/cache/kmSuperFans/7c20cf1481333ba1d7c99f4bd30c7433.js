...
var core_active_skin='kmSuperFans';
...
function kmSuperFans_init()
{
    ...
    kmSuperFans_collect();  // fire first collection on page load
    $(window).resize(kmSuperFans_collect); // fire collection on window resize

    function kmSuperFans_collect()
    {
        menu.css({
            visibility: 'collapse',
 ...
 * @param profile_url
 */
function kmSuperFans_modal(id, profile_url)
{
    $(id).modal();
    if (profile_url) {
...
function kmSuperFans_chart_days(days) {
