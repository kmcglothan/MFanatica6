        ...
        <div class="jp-type-single">
            <div class="jp-gui jp-interface">
                <ul class="jp-controls">
                    <li><a id="{$uniqid}_play" class="jp-play" tabindex="{jrCore_next_tabindex}"><img src="{$play_i}" alt="{$play}" title="{$play}" onmouseover="$(this).attr('src','{$play_h}');" onmouseout="$(this).attr('src','{$play_i}');"></a></li>
                    <li><a class="jp-pause" tabindex="{jrCore_next_tabindex}"><img src="{$pause_i}" alt="{$pause}" title="{$pause}" onmouseover="$(this).attr('src','{$pause_h}');" onmouseout="$(this).attr('src','{$pause_i}');"></a></li>
                </ul>
            </div>
        </div>
    </div>
