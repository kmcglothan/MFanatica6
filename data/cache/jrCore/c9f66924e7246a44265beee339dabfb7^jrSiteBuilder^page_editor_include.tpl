...
<div id="sb-include-section">
    ...
    <div id="sb-layout-section">
        ...
        <div id="sb-page-delete" class="sb-button" onclick="jrCore_confirm('Delete This Page?', 'Are you sure you want to delete this page?',function() { jrSiteBuilder_delete_page('{$page_id}') } )">Delete Page</div>
    ...
    {if isset($notice)}
        ...
        <div id="sb-edit-button" class="sb-button" onclick="jrCore_confirm('Change This Page?', '{$notice|jrCore_entity_string}',function() { jrSiteBuilder_create_and_edit_page() } )">Site Builder</div>
    {else}
