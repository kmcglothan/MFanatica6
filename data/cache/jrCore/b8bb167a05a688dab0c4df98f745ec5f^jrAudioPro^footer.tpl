                            ...
                            <div class="table-cell">
                                <ul class="social clearfix">
                                    {if strlen($_conf.jrAudioPro_facebook_url) > 0 && $_conf.jrAudioPro_facebook_url != "0"}
                                        {if $_conf.jrAudioPro_facebook_url|strpos:"https:" !== false}
                                            <li><a href="{$_conf.jrAudioPro_facebook_url}" class="social-facebook" target="_blank"></a></li>
                                        {else}
                                            <li><a href="https://facebook.com/{$_conf.jrAudioPro_facebook_url}" class="social-facebook" target="_blank"></a></li>
                                        {/if}
                                    {/if}
                                    {if strlen($_conf.jrAudioPro_twitter_url) > 0 && $_conf.jrAudioPro_twitter_url != "0"}
                                        {if $_conf.jrAudioPro_twitter_url|strpos:"https:" !== false}
                                            <li><a href="{$_conf.jrAudioPro_twitter_url}" class="social-twitter" target="_blank"></a></li>
                                        {else}
                                            <li><a href="https://twitter.com/{$_conf.jrAudioPro_twitter_url}" class="social-twitter" target="_blank"></a></li>
                                        {/if}
                                    {/if}
                                    {if strlen($_conf.jrAudioPro_google_url) > 0 && $_conf.jrAudioPro_google_url != "0"}
                                        {if $_conf.jrAudioPro_google_url|strpos:"https:" !== false}
                                            <li><a href="{$_conf.jrAudioPro_google_url}" class="social-google" target="_blank"></a></li>
                                        {else}
                                            <li><a href="https://plus.google.com/u/0/{$_conf.jrAudioPro_google_url}" class="social-google" target="_blank"></a></li>
                                        {/if}
                                    {/if}
                                    {if strlen($_conf.jrAudioPro_linkedin_url) > 0 && $_conf.jrAudioPro_linkedin_url != "0"}
                                        {if $_conf.jrAudioPro_linkedin_url|strpos:"https:" !== false}
                                            <li><a href="{$_conf.jrAudioPro_linkedin_url}" class="social-linkedin" target="_blank"></a></li>
                                        {else}
                                            <li><a href="https://linkedin.com/in/{$_conf.jrAudioPro_linkedin_url}" class="social-linkedin" target="_blank"></a></li>
                                        {/if}
                                    {/if}
                                    {if strlen($_conf.jrAudioPro_youtube_url) > 0 && $_conf.jrAudioPro_youtube_url != "0"}
                                        {if $_conf.jrAudioPro_youtube_url|strpos:"https:" !== false}
                                            <li><a href="{$_conf.jrAudioPro_youtube_url}" class="social-youtube" target="_blank"></a></li>
                                        {else}
                                            <li><a href="https://www.youtube.com/channel/{$_conf.jrAudioPro_youtube_url}" class="social-youtube" target="_blank"></a></li>
                                        {/if}
                                    {/if}
                                </ul>
                            </div>
