...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrMogul_breadcrumbs module="jrGroupDiscuss" profile_url=$profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
...
<div class="box">
    {jrMogul_sort template="icons.tpl" nav_mode="jrGroupDiscuss" profile_url=$profile_url}
    <div class="box_body">
            ...
            {if jrUser_is_logged_in()}
                <div class="action_feedback" style="padding: 0">
                    {if jrGroup_member_has_access($item)}
                        {jrMogul_feedback_buttons module="jrGroupDiscuss" item=$item}
