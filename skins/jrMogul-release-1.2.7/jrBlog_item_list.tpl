    ...
    <div class="page_nav clearfix">
        <div class="breadcrumbs">
            ...
            {if strlen($_post._2) > 0}
                {jrMogul_breadcrumbs module="jrBlog" profile_url=$profile_url page="group" item=$_items[0]}
            {else}
                {jrMogul_breadcrumbs module="jrBlog" profile_url=$profile_url page="group"}
            {/if}
        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <span>
                                                ...
                                                <div class="data clearfix">
                                                    <span>{$item.blog_comment_count|jrCore_number_format} {jrCore_lang skin="jrMogul" id="109" default="Comments"}</span>
                                                    <span>{$item.blog_like_count|jrCore_number_format} {jrCore_lang skin="jrMogul" id="110" default="Likes"}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
