...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrMogul_breadcrumbs module="jrGroupPage" profile_url=$item.profile_url profile_name=$profile_name page="detail" item=$item}
    </div>
...
<div class="box">
    {jrMogul_sort template="icons.tpl" nav_mode="jrGroupPage" profile_url=$profile_url}
    <div class="box_body">
        <div class="wrap detail_section">
            ...
            <div class="action_feedback" style="padding: 0">
                {jrMogul_feedback_buttons module="jrGroupPage" item=$item}
