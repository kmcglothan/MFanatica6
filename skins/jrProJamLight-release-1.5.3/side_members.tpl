...
<div id="head-180-big">
    ...
    {/if}
    <div class="spacer10"></div><i>{jrCore_lang skin=$_conf.jrCore_active_skin id="119" default="Today's"}</i><br><span class="capital bold">{jrCore_lang skin=$_conf.jrCore_active_skin id="21" default="Featured"}&nbsp;{jrCore_lang skin=$_conf.jrCore_active_skin id="142" default="Member"}</span>
</div>
