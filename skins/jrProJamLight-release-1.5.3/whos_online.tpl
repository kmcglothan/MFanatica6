        ...
        <div style="display:table-row">
            ...
            <div class="capital bold" style="display:table-cell;">
                {if $_conf.jrCore_maintenance_mode != 'on' && $_conf.jrUser_signup_on == 'on'}
                    <input type="button" class="form_button" value="{jrCore_lang skin=$_conf.jrCore_active_skin id="2" default="create"}&nbsp;{jrCore_lang skin=$_conf.jrCore_active_skin id="3" default="account"}" onclick="window.location='{$jamroom_url}/{jrCore_module_url module="jrUser"}/signup';">&nbsp;
                {/if}
                <input type="button" class="form_button" value="{jrCore_lang skin=$_conf.jrCore_active_skin id="6" default="login"}" onclick="window.location='{$jamroom_url}/{jrCore_module_url module="jrUser"}/login';">
            </div>
