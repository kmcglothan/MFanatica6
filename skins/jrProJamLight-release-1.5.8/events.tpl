                    ...
                    <div class="row">
                        <div class="col12 last">
                            ...
                            {if isset($_conf.jrProJamLight_require_images) && $_conf.jrProJamLight_require_images == 'on'}
                                {if isset($search)}
                                    {jrCore_list module="jrEvent" order_by=$order_by search="`$search`" tpl_dir="jrProJamLight" template="events_row.tpl" require_image="event_image" pagebreak=$_conf.jrProJamLight_default_events_pagebreak page=$_post.p}
                                {else}
                                    {jrCore_list module="jrEvent" order_by=$order_by tpl_dir="jrProJamLight" template="events_row.tpl" require_image="event_image" pagebreak=$_conf.jrProJamLight_default_events_pagebreak page=$_post.p}
                                {/if}
                            {else}
                                {if isset($search)}
                                    {jrCore_list module="jrEvent" order_by=$order_by search="`$search`" tpl_dir="jrProJamLight" template="events_row.tpl" pagebreak=$_conf.jrProJamLight_default_events_pagebreak page=$_post.p}
                                {else}
                                    {jrCore_list module="jrEvent" order_by=$order_by tpl_dir="jrProJamLight" template="events_row.tpl" pagebreak=$_conf.jrProJamLight_default_events_pagebreak page=$_post.p}
                                {/if}
                            {/if}
                            </div>
                        </div>
