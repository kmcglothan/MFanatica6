...
{if isset($_conf.jrProJamLight_v_category) && $_conf.jrProJamLight_v_category == 'on'}
    {if isset($_post.search_area) && $_post.search_area == 'video_category'}
        ...
        <td class="spacer">&nbsp;</td>
        <td>
            <div id="default" class="p_choice" onclick="jrLoad('#stats','{$jamroom_url}/video_categories');jrSetActive('#default');">{jrCore_lang skin=$_conf.jrCore_active_skin id="167" default="Genres"}</div>
        </td>
    {else}
        <td>
        ...
        <td class="spacer">&nbsp;</td>
        <td>
            <div id="video_genre" class="p_choice" onclick="jrLoad('#stats','{$jamroom_url}/video_categories');jrSetActive('#video_genre');">{jrCore_lang skin=$_conf.jrCore_active_skin id="167" default="Genres"}</div>
        </td>
    {/if}
{else}
        <td>
