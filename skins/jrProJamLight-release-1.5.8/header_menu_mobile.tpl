    ...
    <nav>
        <ul class="sb-menu">
            ...
            {if jrCore_module_is_active('jrSiteBuilder')}
                ...
                {jrSiteBuilder_default_menu title="Artists" url="artists" weight="1"}
                {jrSiteBuilder_default_menu title="By Newest" url="artists/by_newest" parent="artists" weight="2"}
                {jrSiteBuilder_default_menu title="Most Viewed" url="artists/most_viewed" parent="artists" weight="3"}
                {jrSiteBuilder_default_menu title="Members" url="members" parent="artists" weight="4"}
                {jrSiteBuilder_default_menu title="Music" url="music" weight="5"}
                ...
                {jrSiteBuilder_default_menu title="Music Charts" url="music_charts" parent="music" weight="8"}
                ...
                {jrSiteBuilder_default_menu title="By Plays" url="videos/by_plays" parent="videos" weight="15"}
                {jrSiteBuilder_default_menu title="By Ratings" url="videos/by_ratings" parent="videos" weight="16"}
                {jrSiteBuilder_default_menu title="Video Charts" url="video_charts" parent="videos" weight="17"}
                {jrSiteBuilder_default_menu title="Weekly" url="video_charts_weekly" parent="video_charts" weight="18"}
                {jrSiteBuilder_default_menu title="Monthly" url="video_charts_monthly" parent="video_charts" weight="19"}
                {jrSiteBuilder_default_menu title="Yearly" url="video_charts_yearly" parent="video_charts" weight="20"}
                {jrSiteBuilder_default_menu title="Channels" url="channels" parent="videos" weight="21"}
                {jrSiteBuilder_default_menu title="YouTube Videos" url="youtube_videos" parent="videos" weight="22"}
                {jrSiteBuilder_default_menu title="Vimeo Videos" url="vimeo_videos" parent="videos" weight="23"}
                {jrSiteBuilder_default_menu title="Galleries" url="galleries" weight="24"}
                {jrSiteBuilder_default_menu title="Gigs/Events" url="events" weight="25"}
                {jrSiteBuilder_default_menu title="By Upcoming" url="events/by_upcoming" parent="events" weight="26"}
                {jrSiteBuilder_default_menu title="By Ratings" url="by-ratings" parent="events" weight="27"}
                {jrSiteBuilder_default_menu title="Blogs" url="site_blogs" weight="28"}
                {jrSiteBuilder_default_menu title="Articles" url="articles" parent="site_blogs" weight="29"}
                {jrSiteBuilder_default_menu title="News" url="news" parent="site_blogs" weight="30"}
            ...
            {else}
                ...
                <li>
                    <a href="{$jamroom_url}/artists"{if isset($selected) && $selected == 'lists'} style="color:{$active_color};"{/if}>{jrCore_lang skin=$_conf.jrCore_active_skin id="48" default="artists"}</a>
                    <ul>
                        <li>
                ...
                <li>
                    <a href="{$jamroom_url}/videos"{if isset($selected) && ($selected == 'videos' || $selected == 'channels' || $selected == 'ext_videos')} style="color:{$active_color};"{/if}>{jrCore_lang skin=$_conf.jrCore_active_skin id="14" default="videos"}</a>
                    <ul>
                ...
                <li>
                    <a href="{$jamroom_url}/site_blogs"{if isset($selected) && $selected == 'ban'} style="color:{$active_color};"{/if}>{jrCore_lang skin=$_conf.jrCore_active_skin id="140" default="blogs"}</a>
                    <ul>
            ...
            {elseif jrCore_module_is_active('jrFoxyCart') && strlen($_conf.jrFoxyCart_api_key) > 0}
                {if jrUser_is_logged_in()}
                    <li>
                        <a href="{$_conf.jrFoxyCart_store_domain}/cart?cart=view">{jrCore_lang skin=$_conf.jrCore_active_skin id="182" default="Cart"}<span id="fc_minicart"><span id="fc_quantity"></span></span></a>
                    </li>
                {/if}
            {/if}
