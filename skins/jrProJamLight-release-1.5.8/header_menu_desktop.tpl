...
<div id="menu_content">
    <nav id="menu-wrap">
        <ul id="menu">
            ...
            {jrCore_lang skin=$_conf.jrCore_active_skin id="182" default="Cart" assign="ct"}
                {if jrUser_is_logged_in()}
                    <li>
                        <a href="{$_conf.jrFoxyCart_store_domain}/cart?cart=view">{jrCore_image image="cart.png" width="24" height="24" alt=$ct}<span id="fc_minicart"><span id="fc_quantity"></span></span></a>
                    </li>
                {/if}
            {/if}
