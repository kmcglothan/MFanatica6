                        ...
                        <div class="col12 last">
                            ...
                            <div class="body_3">
                                ...
                                {if isset($_conf.jrProJamLight_require_images) && $_conf.jrProJamLight_require_images == 'on'}
                                    {if isset($_post.search_area) && $_post.search_area == 'audio_genre'}
                                        {jrCore_list module="jrAudio" order_by=$order_by search1="audio_genre like `$_post.search_string`" template="music_row.tpl" require_image="audio_image" pagebreak=$_conf.jrProJamLight_default_pagebreak page=$_post.p}
                                    {elseif !empty($_post._1)}
                                        {jrCore_list module="jrAudio" order_by=$order_by template="music_row.tpl" require_image="audio_image" search="audio_title like `$_post._1`%" pagebreak=$_conf.jrProJamLight_default_pagebreak page=$_post.p}
                                    {else}
                                        {jrCore_list module="jrAudio" order_by=$order_by template="music_row.tpl" require_image="audio_image" pagebreak=$_conf.jrProJamLight_default_pagebreak page=$_post.p}
                                    {/if}
                                {else}
                                    {if isset($_post.search_area) && $_post.search_area == 'audio_genre'}
                                        {jrCore_list module="jrAudio" order_by=$order_by search1="audio_genre like `$_post.search_string`" template="music_row.tpl" pagebreak=$_conf.jrProJamLight_default_pagebreak page=$_post.p}
                                    {elseif !empty($_post._1)}
                                        {jrCore_list module="jrAudio" order_by=$order_by template="music_row.tpl" search="audio_title like `$_post._1`%" pagebreak=$_conf.jrProJamLight_default_pagebreak page=$_post.p}
                                    {else}
                                        {jrCore_list module="jrAudio" order_by=$order_by template="music_row.tpl" pagebreak=$_conf.jrProJamLight_default_pagebreak page=$_post.p}
                                    {/if}
                                {/if}
