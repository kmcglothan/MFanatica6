...
{if isset($_conf.jrProJamLight_require_images) && $_conf.jrProJamLight_require_images == 'on'}
    {jrCore_list module="jrVideo" order_by="_item_id numerical_desc" template=$new_videos_template require_image="video_image" pagebreak="3" page=$_post.p}
{else}
    {jrCore_list module="jrVideo" order_by="_item_id numerical_desc" template=$new_videos_template pagebreak="3" page=$_post.p}
{/if}
