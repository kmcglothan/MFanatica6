            ...
            <div class="callbacks_container">
                <div class="ioutline" style="max-width:495px;margin:0 auto;border:1px solid #333;">
                    ...
                    {if isset($_conf.jrProJamLight_news_profile) && $_conf.jrProJamLight_news_profile > 0}
                        {jrCore_list module="jrBlog" order_by="_created desc" limit="10" search1="_profile_id in `$_conf.jrProJamLight_news_profile`" search2="blog_category = latest" template="news_slider.tpl"}
                    {else}
        ...
        {literal}
            ...
            <div class="body_2">
                ...
                <div class="block_config">
                    <a onclick="jrCore_window_location('{$jamroom_url}/{$item.profile_url}/{$burl}/{$item._item_id}/{$item.blog_title_url}');">{jrCore_icon icon="gear"}</a>
                </div>
                {/if}
...
{* LATEST BLOGS AND NEWS *}
    <div class="col4">
        ...
        {jrCore_list module="jrBlog" order_by="_created desc" search1="blog_category not_in about,news,welcome,latest,featured,exclusive" limit="5" template="blogs_row.tpl"}
        </div>
    </div>
...
{* SITE NEWS, BLOGS AND ABOUT *}
    <div class="col12 last">
        ...
        <table class="menu_tab">
            <tr>
                <td>
                    <div id="site_news" class="p_choice_site_blogs" onclick="jrLoad('#site_news_div','{$jamroom_url}/site_news');$('html, body').animate({ scrollTop: $('#mnews').offset().top -100 }, 'slow');jrSetActiveSiteBlog('#site_news');" style="font-size:10px;font-weight:bold;padding-left:4px;padding-right:4px;">{jrCore_lang skin=$_conf.jrCore_active_skin id="116" default="Site News"}</div>
                </td>
                <td class="spacer">&nbsp;</td>
                <td>
