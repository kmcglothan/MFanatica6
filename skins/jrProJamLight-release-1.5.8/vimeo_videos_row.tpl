            ...
            <div class="row">
                ...
                <div class="col9">
                    <div class="p5" style="padding-left:10px;">
                        ...
                        <span class="capital">{jrCore_lang module="jrVimeo" id="14" default="Category"}:</span> <span class="hilite">{$item.vimeo_category}</span><br>
                        {if isset($_post.option) && $_post.option == 'by_plays'}
                            <span class="capital">{jrCore_lang skin=$_conf.jrCore_active_skin id="51" default="plays"}:</span> <span class="hilite">{$item.vimeo_stream_count}</span><br>
                        {/if}
                        <span class="capital">{jrCore_lang module="jrVimeo" id="35" default="Duration"}:</span> <span class="hilite_2">{$item.vimeo_duration}</span><br>
                        <div class="p5">
