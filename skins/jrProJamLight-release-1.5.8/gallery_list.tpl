{if isset($_post.option) && $_post.option == 'alpha'}
    ...
    {assign var="gpb" value=$_conf.jrProJamLight_default_gallery_pagebreak}
...
{if isset($_conf.jrProJamLight_require_images) && $_conf.jrProJamLight_require_images == 'on'}
    ...
    {else}
        {jrCore_list module="jrGallery" order_by="gallery_rating_1_average_count numerical_desc" group_by="_profile_id, gallery_title_url" template="galleries_row.tpl" require_image="gallery_image" pagebreak=$gpb page=$_post.p}
    {/if}
{else}
    {if isset($_post.option) && $_post.option != 'top'}
    ...
    {else}
        {jrCore_list module="jrGallery" order_by="gallery_rating_1_average_count numerical_desc" group_by="_profile_id, gallery_title_url" template="galleries_row.tpl" pagebreak=$gpb page=$_post.p}
    {/if}
{/if}
