...
<div class="mb20 pt10">
    ...
    {if isset($_conf.jrMediaProLight_featured_song) && strlen($_conf.jrMediaProLight_featured_song) > 0}
        {jrCore_list module="jrAudio" order_by="_item_id desc" limit="1" search1="profile_active = 1" search2="_item_id = `$_conf.jrMediaProLight_featured_song`" template=$featured_song}
    {else}
        {jrCore_list module="jrAudio" order_by="audio_file_stream_count numerical_desc" limit="1" search1="profile_active = 1" quota_id=$_conf.jrMediaProLight_artist_quota template=$featured_song}
    {/if}
</div>
