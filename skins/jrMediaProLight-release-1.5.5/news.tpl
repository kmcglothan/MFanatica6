                ...
                <div class="container">
                            ...
                            <div class="body_1">
                                ...
                                <div class="callbacks_container">
                                    ...
                                    {if isset($_conf.jrMediaProLight_blog_profile) && $_conf.jrMediaProLight_blog_profile > 0}
                                        {jrCore_list module="jrBlog" order_by="_created desc" limit="10" search1="_profile_id in `$_conf.jrMediaProLight_blog_profile`" search2="blog_category = latest" template="news_slider.tpl"}
                                    {else}
                    ...
                    {* EXCLUSIVE NEWS *}
                        <div class="col4 last">
                            ...
                            {if isset($_conf.jrMediaProLight_blog_profile) && $_conf.jrMediaProLight_blog_profile > 0}
                                {jrCore_list module="jrBlog" order_by="_created desc" limit="1" search1="_profile_id in `$_conf.jrMediaProLight_blog_profile`" search2="blog_category = exclusive" template=$exclusive_news}
                            {else}
