...
{if isset($_conf.jrMediaProLight_blog_profile) && $_conf.jrMediaProLight_blog_profile > 0}
    {jrCore_list module="jrBlog" order_by="_created desc" profile_id=$_conf.jrMediaProLight_blog_profile search2="blog_category = blog" template=$bloglist pagebreak="10" page=$_post.p}
{else}
