...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrMaestro_breadcrumbs module="jrAudio" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
        ...
        <div class="box_body">
            <div class="wrap detail_section">
                ...
                {elseif $item.audio_file_extension == 'mp3'}
                    {jrCore_media_player module="jrAudio" field="audio_file" item=$item autoplay=$_conf.jrMaestro_auto_play}
                {/if}
                <div class="detail_box">
                    <div class="basic-info">
                        ...
                        <div class="item" style="display: none; padding: 0; margin: 5px auto 0;">
                            <div style="display: table; width: 100%;">
                                <div class="header">
                                    <div>{jrCore_lang skin="jrMaestro" id=21 default="Album"}</div>
                                    <div>{jrCore_lang skin="jrMaestro" id=39 default="Genre"}</div>
                    ...
                    {if strlen($item.audio_lyrics) > 0}
                        <div class="lyrics">
                            <div class="trigger"><span>{jrCore_lang skin="jrMaestro" id="116" default="Lyrics"}</span></div>
                            <div class="item" style="display: none;">
                                {$item.audio_lyrics}
                            </div>
                        </div>
                ...
                <div class="action_feedback" style="padding: 0">
                    {jrMaestro_feedback_buttons module="jrAudio" item=$item}
