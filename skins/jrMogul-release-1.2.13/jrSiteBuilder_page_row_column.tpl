                                    ...
                                    <div id="c{$_widget.widget_id}" class="sb-widget-block box">
                                        ...
                                        {elseif strlen($_widget.widget_module) > 0}
                                            ...
                                            {if $_widget.widget_module == 'jrCore'}
                                                ...
                                                {jrMogul_sort template="icons.tpl" nav_mode=$data.list_module title=$_widget.widget_title} <span>{$_widget.widget_title}</span>

                                            {else}
                                                {jrMogul_sort template="icons.tpl" nav_mode=$_widget.widget_module title=$_widget.widget_title} <span>{$_widget.widget_title}</span>
                                            {/if}
                                        {/if}
                                        {if jrUser_is_master()}
