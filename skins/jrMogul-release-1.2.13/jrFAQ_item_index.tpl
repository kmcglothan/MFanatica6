...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrMogul_breadcrumbs module="jrFAQ" profile_url=$profile_url profile_name=$profile_name page="index"}
    </div>
...
<div class="box">
    {jrMogul_sort template="icons.tpl" nav_mode="jrFAQ" profile_url=$profile_url}
    <div class="box_body">
        <div class="wrap">
