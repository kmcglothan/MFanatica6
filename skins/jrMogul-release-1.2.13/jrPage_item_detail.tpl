...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrMogul_breadcrumbs module="jrPage" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
            ...
            {if $_post.module_url != 'page'}
                ...
                <div class="action_feedback">
                    ...
                    {if !isset($item.page_features) || $item.page_features == 'on'}
                        {jrMogul_feedback_buttons module="jrPage" item=$item}
