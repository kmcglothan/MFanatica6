...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrMogul_breadcrumbs module="jrPoll" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
...
<div class="col8">
    <div class="box">
        {jrMogul_sort template="icons.tpl" nav_mode="jrPoll" profile_url=$profile_url}
        <div class="box_body">
            <div class="wrap detail_section">
                ...
                <div class="action_feedback">
                    {jrMogul_feedback_buttons module="jrPoll" item=$item}
