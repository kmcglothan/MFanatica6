<div class="box">
    {jrMogul_sort template="icons.tpl" nav_mode="menu" profile_url=$profile_url}
    <div class="box_body">
        <div class="wrap">
            <ul class="tm">
                <li>
                ...
                <li>
                    <a href="{$jamroom_url}/{$profile_url}/{$murl}/feedback">
                        {if isset($_post.profile_actions) && $_post.profile_actions == 'feedback'}
                            <strong>{jrCore_lang skin="jrMogul" id=120 default="Feedback"}</strong>
                        {else}
                            {jrCore_lang skin="jrMogul" id=120 default="Feedback"}
                        {/if}
                    </a>
                </li>
            </ul>
