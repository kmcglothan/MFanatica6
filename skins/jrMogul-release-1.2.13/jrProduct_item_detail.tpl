...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrMogul_breadcrumbs module="jrProduct" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
...
<div class="col8">
    <div class="box">
        {jrMogul_sort template="icons.tpl" nav_mode="jrProduct" profile_url=$profile_url}
        <div class="box_body">
            <div class="wrap detail_section">
                ...
                <div class="action_feedback">
                    {jrMogul_feedback_buttons module="jrProduct" item=$item}
...
<div class="col4 last">
    <div class="box">
        {jrMogul_sort template="icons.tpl" nav_mode="jrProduct" profile_url=$profile_url single=true}
