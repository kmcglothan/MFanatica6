            ...
            <div class="wrap clearfix">
                ...
                <div class="col8">
                    ...
                    <div class="data clearfix">
                        <span>{$item.soundcloud_comment_count|jrCore_number_format} {jrCore_lang skin="jrCelebrity" id="109" default="Comments"}</span>
                        <span>{$item.soundcloud_like_count|jrCore_number_format} {jrCore_lang skin="jrCelebrity" id="110" default="Likes"}</span>
                    </div>
                </div>
            </div>
        </div>
