...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrCelebrity_breadcrumbs module="jrGroupDiscuss" profile_url=$profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
...
<div class="box">
    {jrCelebrity_sort template="icons.tpl" nav_mode="jrGroupDiscuss" profile_url=$profile_url}
    <div class="box_body">
            ...
            <div id="list">
                ...
                <div class="action_feedback" style="padding:0">
                    {if jrGroup_member_has_access($item)}
                        {jrCelebrity_feedback_buttons module="jrGroupDiscuss" item=$item}
                        {if jrCore_module_is_active('jrRating')}
                            <div class="rating" id="jrGroupDiscuss_{$item._item_id}_rating">
                                {jrCore_module_function function="jrRating_form" type="star" module="jrGroupDiscuss" index="1" item_id=$item._item_id current=$item.discuss_rating_1_average_count|default:0 votes=$item.discuss_rating_1_number|default:0}
                            </div>
                        {/if}
