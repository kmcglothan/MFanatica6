...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrCelebrity_breadcrumbs module="jrGallery" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
...
<div class="col8">
    <div class="box">
        {jrCelebrity_sort template="icons.tpl" nav_mode="jrGallery" profile_url=$profile_url}
        <span>{jrCore_lang skin="jrCelebrity" id="113" default="Images"} by {$item.profile_name}</span>
        <div class="box_body">
            <div class="wrap detail_section">
                ...
                <div class="action_feedback">
                    {jrCelebrity_feedback_buttons module="jrGallery" item=$item}
                    {if jrCore_module_is_active('jrRating')}
                        <div class="rating" id="jrGallery_{$item._item_id}_rating">{jrCore_module_function
