...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrCelebrity_breadcrumbs module="jrStore" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
        ...
        <div class="box_body">
            <div class="wrap detail_section">
                ...
                <div class="action_feedback">
                    {jrCelebrity_feedback_buttons module="jrStore" item=$item}
...
<div class="col4 last">
    <div class="box">
        {jrCelebrity_sort template="icons.tpl" nav_mode="jrStore" profile_url=$profile_url single=true}
