...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrCelebrity_breadcrumbs module="jrPoll" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
...
<div class="col8">
    <div class="box">
        {jrCelebrity_sort template="icons.tpl" nav_mode="jrPoll" profile_url=$profile_url}
        <div class="box_body">
            <div class="wrap detail_section">
                ...
                <div class="action_feedback">
                    {jrCelebrity_feedback_buttons module="jrPoll" item=$item}
                    {if jrCore_module_is_active('jrRating')}
                        <div class="rating" id="jrPoll_{$item._item_id}_rating">{jrCore_module_function
                            function="jrRating_form"
                            type="star"
                            module="jrPoll"
                            index="1"
                            item_id=$item._item_id
                            current=$item.poll_rating_1_average_count|default:0
                            votes=$item.poll_rating_1_number|default:0}</div>
                    {/if}
