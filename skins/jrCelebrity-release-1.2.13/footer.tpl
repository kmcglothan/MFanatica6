        ...
        <div class="col12">
            <div class="social">
                ...
                <ul class="social clearfix">
                    {if strlen($_conf.jrCelebrity_facebook_url) > 1}
                        {if $_conf.jrCelebrity_facebook_url|strpos:"https:" !== false}
                            <li><a href="{$_conf.jrCelebrity_facebook_url}" class="social-facebook" target="_blank"></a></li>
                        {else}
                            <li><a href="https://facebook.com/{$_conf.jrCelebrity_facebook_url}" class="social-facebook" target="_blank"></a></li>
                        {/if}
                    {/if}
                    {if strlen($_conf.jrCelebrity_twitter_url) > 1}
                        {if $_conf.jrCelebrity_twitter_url|strpos:"https:" !== false}
                            <li><a href="{$_conf.jrCelebrity_twitter_url}" class="social-twitter" target="_blank"></a></li>
                        {else}
                            <li><a href="https://twitter.com/{$_conf.jrCelebrity_twitter_url}" class="social-twitter" target="_blank"></a></li>
                        {/if}
                    {/if}
                    {if strlen($_conf.jrCelebrity_google_url) > 1}
                        {if $_conf.jrCelebrity_google_url|strpos:"https:" !== false}
                            <li><a href="{$_conf.jrCelebrity_google_url}" class="social-google" target="_blank"></a></li>
                        {else}
                            <li><a href="https://plus.google.com/u/0/{$_conf.jrCelebrity_google_url}" class="social-google" target="_blank"></a></li>
                        {/if}
                    {/if}
                    {if strlen($_conf.jrCelebrity_linkedin_url) > 1}
                        {if $_conf.jrCelebrity_linkedin_url|strpos:"https:" !== false}
                            <li><a href="{$_conf.jrCelebrity_linkedin_url}" class="social-linkedin" target="_blank"></a></li>
                        {else}
                            <li><a href="https://linkedin.com/in/{$_conf.jrCelebrity_linkedin_url}" class="social-linkedin" target="_blank"></a></li>
                        {/if}
                    {/if}
                    {if strlen($_conf.jrCelebrity_youtube_url) > 1}
                        {if $_conf.jrCelebrity_youtube_url|strpos:"https:" !== false}
                            <li><a href="{$_conf.jrCelebrity_youtube_url}" class="social-youtube" target="_blank"></a></li>
                        {else}
                            <li><a href="https://www.youtube.com/channel/{$_conf.jrCelebrity_youtube_url}" class="social-youtube" target="_blank"></a></li>
                        {/if}
                    {/if}
                </ul>
