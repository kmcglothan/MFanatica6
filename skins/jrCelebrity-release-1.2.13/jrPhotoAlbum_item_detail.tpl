...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrCelebrity_breadcrumbs module="jrPhotoAlbum" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
...
<div class="box">
    {jrCelebrity_sort template="icons.tpl" nav_mode="jrPhotoAlbum" profile_url=$profile_url}
    <div class="box_body">
        <div class="wrap detail_section">
            ...
            <div class="action_feedback">
                {jrCelebrity_feedback_buttons module="jrPhotoAlbum" item=$item}
