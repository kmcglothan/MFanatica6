...
<div class="action_info">
    ...
    <div class="action_data">
        ...
        {jrCore_lang skin="jrCelebrity" id=152 default="rated"} <span class="action_user_name"><a href="{$jamroom_url}/{$item.action_original_data.profile_url}">@{$item.action_original_data.profile_url}'s</a></span>
        {jrCore_lang module=$item.action_data.rating_module id="menu"} {jrCore_lang skin="jrCelebrity" id=153 default="with a"} &quot;{$item.action_data.rating_value}&quot;
        <br>
