...
{if $module == "jrAction"}
    ...
    {if $page == 'feedback'}
        <a href="{$jamroom_url}/{$profile_url}/{$nav_murl}/feedback">{jrCore_lang skin="jrCelebrity" id=120 default="Feedback"}</a>
    {/if}
...
{elseif $module == "jrBlog"}
    ...
    {if $page == 'detail' || $page == 'group'}
        <a href="{$jamroom_url}/{$profile_url}/{$nav_murl}/category">{jrCore_lang skin="jrCelebrity" id="22" default="Categories"}</a>
    {/if}
...
{elseif $module == "jrEvent"}
    ...
    {if $page == 'detail' || $page == 'group'}
        <a href="{$jamroom_url}/{$profile_url}/{$nav_murl}/calendar">{jrCore_lang skin="jrCelebrity" id="30" default="Calendar"}</a>
    {/if}
...
{elseif $module == "jrComment"}
    ...
    {if $page == 'detail'}
        <a href="{$jamroom_url}/{$profile_url}/{$nav_murl}/{$item._item_id}/">{jrCore_lang skin="jrCelebrity" id="147" default="Detail"}</a>
    {/if}
