...
$(document).ready(function(){
    ...
    var autoPlayCookie = jrReadCookie('jrMogul_audio_autoplay');
    ...
    $('#jp_container_{$uniqid} #jp-auto-play').click(function() {
        jrSetCookie('jrMogul_audio_autoplay', 0, 31);
        if ($(this).is(':checked')) {
            jrSetCookie('jrMogul_audio_autoplay', 1, 31);
        }
    });
});
</script>

<div class="jrMogul_player audio" onclick="event.cancelBubble = true; if(event.stopPropagation) event.stopPropagation();">
