...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrMogul_breadcrumbs module="jrVimeo" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
...
<div class="col8">
    <div class="box">
        {jrMogul_sort template="icons.tpl" nav_mode="jrVimeo" profile_url=$profile_url}
        <div class="box_body">
            <div class="wrap detail_section">
                {jrVimeo_embed type="iframe" item_id=$item._item_id auto_play=$_conf.jrMogul_auto_play width="100%"}
                ...
                <div class="action_feedback">
                    {jrMogul_feedback_buttons module="jrVimeo" item=$item}
