...
function jrMogul_init()
{
    ...
    setTimeout(jrMogul_check_pulse, 1000);
    setInterval(jrMogul_check_pulse, 30000);
    ...
    jrMogul_collect();  // fire first collection on page load
    $(window).resize(jrMogul_collect); // fire collection on window resize

    function jrMogul_collect()
    {
        menu.css({
            visibility: 'collapse',
 ...
 */
function jrMogul_open_div(div, f)
{
 ...
 * @returns {boolean}
 */
function jrMogul_reply_to(item_id, user_name, div)
{
 ...
 * @param profile_url
 */
function jrMogul_modal(id, profile_url)
{
    $(id).modal();
    if (profile_url) {
 ...
 */
function jrMogul_watch_timeline()
{
 ...
 * @returns {boolean}
 */
function jrMogul_load_more_timeline(next_page, this_page)
{
