                    ...
                    <div class="featured_item">
                        <div class="cover_image">
                            ...
                            {if $item.profile_header_image_size > 0}
                                <a href="{$jamroom_url}/{$item.profile_url}"  title="{jrCore_lang skin="jrAudioPro" id="34" default="Click to view"}">
                        ...
                        <div class="wrap">
                            ...
                            {/if}
                            {if jrCore_module_is_active('jrCombinedAudio') && $_conf.jrAudioPro_list_2_soundcloud == 'on'}
