            ...
            <div class="row">
                ...
                <div class="col9">
                    <div class="p5" style="padding-left:10px;">
                        ...
                        <span class="capital">{jrCore_lang module="jrVimeo" id="14" default="Category"}:</span> <span class="normal">{$item.vimeo_category}</span>&nbsp;
                        <span class="capital">{jrCore_lang module="jrVimeo" id="23" default="Duration"}:</span> <span class="normal">{$item.vimeo_duration}</span><br>
