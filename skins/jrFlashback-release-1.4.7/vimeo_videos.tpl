            ...
            <div class="body_1 mr5">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col12 last">
                            <div class="title">
                                {jrCore_lang skin=$_conf.jrCore_active_skin id="72" default="Vimeo"}&nbsp;
                                <span class="separator">&nbsp;&nbsp;&nbsp;&nbsp;</span>&nbsp;
                                {if !isset($_post.option) || $_post.option == 'by_newest'}
                                    {jrCore_lang skin=$_conf.jrCore_active_skin id="11" default="newest"}&nbsp;
                                {else}
                                    <a href="{$jamroom_url}/vimeo_videos/by_newest{if isset($_post._1) && strlen($_post._1) > 0}/{$_post._1}{/if}">{jrCore_lang skin=$_conf.jrCore_active_skin id="11" default="newest"}</a>&nbsp;
                                {/if}
                                ...
                                {else}
                                    <a href="{$jamroom_url}/vimeo_videos/by_plays{if isset($_post._1) && strlen($_post._1) > 0}/{$_post._1}{/if}">{jrCore_lang skin=$_conf.jrCore_active_skin id="59" default="by plays"}</a>
                                {/if}
                                ...
                                {else}
                                    <a href="{$jamroom_url}/vimeo_videos/by_ratings{if isset($_post._1) && strlen($_post._1) > 0}/{$_post._1}{/if}">{jrCore_lang skin=$_conf.jrCore_active_skin id="60" default="by rating"}</a>
                                {/if}
                            </div>
                            <div class="alpha_title">&raquo;&nbsp;
                                ...
                                {foreach from=$alpha item="char"}
                                    <a href="{$jamroom_url}/vimeo_videos{if isset($_post.option) && strlen($_post.option) > 0}/{$_post.option}{else}/by_newest{/if}/{$char}">{$char}</a>&nbsp;
                                {/foreach}
                                &laquo;&nbsp;
                                <a href="{$jamroom_url}/vimeo_videos{if isset($_post.option) && strlen($_post.option) > 0}/{$_post.option}{/if}">{jrCore_lang skin=$_conf.jrCore_active_skin id="105" default="Reset"}</a>
                            </div>
                            <div class="body_3">
                                {jrCore_list module="jrVimeo" order_by=$order_by template="vimeo_videos_row.tpl" search="vimeo_title like `$_post._1`%" pagebreak=$_conf.jrFlashback_default_pagebreak page=$_post.p}
                            </div>
                        </div>
                    </div>
                </div>
