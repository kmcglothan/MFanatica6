{assign var="active_color" value="#006699"}
    ...
    <nav>
        <ul class="sb-menu">
            ...
            {if jrCore_module_is_active('jrSiteBuilder')}
                ...
                {jrSiteBuilder_default_menu title="Video" url="video" parent="music_charts" weight="9"}
                {jrSiteBuilder_default_menu title="Weekly" url="video_charts" parent="video" weight="10"}
                {jrSiteBuilder_default_menu title="Monthly" url="video_charts_monthly" parent="video" weight="11"}
                {jrSiteBuilder_default_menu title="Yearly" url="video_charts_yearly" parent="video" weight="12"}
            ...
            <li>
                ...
                {/if}
                <a href="{$jamroom_url}/community"{if (isset($selected) && $selected == 'community') || (isset($_post._uri) && $_post._uri == $forum_uri) || (isset($_post._uri) && $_post._uri == $doc_uri)} style="color:{$active_color};"{/if}>{jrCore_lang skin=$_conf.jrCore_active_skin id="26" default="community"}</a>
                <ul>
            ...
            {if jrCore_module_is_active('jrCharts')}
                <li>
                    <a href="{$jamroom_url}/music_charts"{if isset($selected) && $selected == 'charts'} style="color:{$active_color};"{/if}>{jrCore_lang skin=$_conf.jrCore_active_skin id="27" default="charts"}</a>
                    <ul>
                        <li>
            ...
            {/if}
            <li>
                <a href="{$jamroom_url}/artists"{if isset($selected) && $selected == 'lists'} style="color:{$active_color};"{/if}>{jrCore_lang skin=$_conf.jrCore_active_skin id="28" default="lists"}</a>
                <ul>
                    <li>
            ...
            <li>
                <a href="{$jamroom_url}/events"{if isset($selected) && $selected == 'events'} style="color:{$active_color};"{/if}>{jrCore_lang skin=$_conf.jrCore_active_skin id="30" default="events"}</a>
                <ul>
            ...
            <li><a href="{$jamroom_url}/articles"{if isset($selected) && $selected == 'articles'} style="color:{$active_color};"{/if}>{jrCore_lang skin=$_conf.jrCore_active_skin id="67" default="articles"}</a></li>
        ...
        {if jrCore_module_is_active('jrFoxyCart') && strlen($_conf.jrFoxyCart_api_key) > 0}
            <li>
                <a href="{$_conf.jrFoxyCart_store_domain}/cart?cart=view">{jrCore_lang skin=$_conf.jrCore_active_skin id="132" default="Cart"}<span id="fc_quantity"></span></span></a>
            </li>
        {/if}
