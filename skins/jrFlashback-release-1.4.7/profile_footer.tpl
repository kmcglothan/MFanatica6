<div class="col3 last">
    <div style="margin-top: 10px;">
        ...
        {if jrCore_module_is_active('jrFollower')}
            {jrCore_list module="jrFollower" limit="12" search1="follow_profile_id = `$_profile_id`" search2="follow_active = 1" order_by="_created desc" assign="followers"}
            {if isset($followers) && strlen($followers) > 0}
                <div class="head_2">
                    ...
                    {jrCore_lang skin=$_conf.jrCore_active_skin id="100" default="Followers"}:
                </div>
                <div class="block">
                    <div class="block_content mt10">
                        <div class="body_3 center">
                            {$followers}
                        </div>
                    </div>
                </div>
