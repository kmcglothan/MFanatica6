                        ...
                        <div class="col12 last">
                            ...
                            <div class="body_3">
                                {if isset($_conf.jrFlashback_require_images) && $_conf.jrFlashback_require_images == 'on'}
                                    {jrCore_list module="jrAudio" chart_field="audio_file_stream_count" chart_days="365" tpl_dir="jrFlashback" template="music_chart_row.tpl" require_image="audio_image" pagebreak=$_conf.jrFlashback_default_pagebreak page=$_post.p}
                                {else}
                                    {jrCore_list module="jrAudio" chart_field="audio_file_stream_count" chart_days="365" tpl_dir="jrFlashback" template="music_chart_row.tpl" pagebreak=$_conf.jrFlashback_default_pagebreak page=$_post.p}
                                {/if}
                            </div>
                        </div>
                    </div>
