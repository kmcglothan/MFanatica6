            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    {* Logo *}
                        <div id="main_logo">
                        {if jrCore_is_mobile_device() || jrCore_is_tablet_device()}
                            {jrCore_image id="mmt" skin="jrFlashback" image="menu.png" alt="menu" style="max-width:28px;max-height:28px;"}
                            {jrCore_image image="logo.png" class="jlogo img_scale" alt=$_conf.jrCore_system_name title=$_conf.jrCore_system_name style="max-width:225px;max-height:52px;" custom="logo"}
                        {else}
                            <a href="{$jamroom_url}">{jrCore_image image="logo.png" class="jlogo img_scale" alt=$_conf.jrCore_system_name title=$_conf.jrCore_system_name style="max-width:325px;max-height:75px;" custom="logo"}</a>
                        {/if}
                        </div>
                    </div>
                    ...
                    <div class="col6 last">
                        ...
                        <div class="logo-ads">
                            ...
                            {elseif isset($_conf.jrFlashback_top_ad) && strlen($_conf.jrFlashback_top_ad) > 0}
                                {$_conf.jrFlashback_top_ad}
                            {else}
