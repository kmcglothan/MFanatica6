...
{if isset($_conf.jrMediaPro_slider_profile_ids) && $_conf.jrMediaPro_slider_profile_ids > 0}
    {assign var="list" value=$_conf.jrMediaPro_slider_profile_ids}
{else}
                    ...
                    <section class="slider">
                            ...
                            <ul class="slides">
                                {if isset($list)}
                                    {if isset($_conf.jrMediaPro_require_images) && $_conf.jrMediaPro_require_images == 'on'}
                                        {jrCore_list module="jrProfile" limit="21" quota_id=$_conf.jrMediaPro_artist_quota search1="_item_id in `$list`" template="index_slider.tpl" require_image="profile_image"}
                                    {else}
                                        {jrCore_list module="jrProfile" limit="21" quota_id=$_conf.jrMediaPro_artist_quota search1="_item_id in `$list`" template="index_slider.tpl"}
                                    {/if}
                                {else}
                                    {if isset($_conf.jrMediaPro_require_images) && $_conf.jrMediaPro_require_images == 'on'}
                                        {jrCore_list module="jrProfile" order_by="_created desc" quota_id=$_conf.jrMediaPro_artist_quota search1="profile_active = 1" search2="profile_jrAudio_item_count > 0" template="index_slider.tpl" limit="21" require_image="profile_image"}
                                    {else}
                                        {jrCore_list module="jrProfile" order_by="_created desc" quota_id=$_conf.jrMediaPro_artist_quota search1="profile_active = 1" search2="profile_jrAudio_item_count > 0" template="index_slider.tpl" limit="21"}
                                    {/if}
                                {/if}
                            </ul>
                        </div>
                        <div id="carousel" class="flexslider">
                            <ul class="slides">
                                {if isset($list)}
                                    {if isset($_conf.jrMediaPro_require_images) && $_conf.jrMediaPro_require_images == 'on'}
                                        {jrCore_list module="jrProfile" quota_id=$_conf.jrMediaPro_artist_quota search1="_item_id in `$list`" template="index_slider_thumbs.tpl" limit="21" require_image="profile_image"}
                                    {else}
                                        {jrCore_list module="jrProfile" quota_id=$_conf.jrMediaPro_artist_quota search1="_item_id in `$list`" template="index_slider_thumbs.tpl" limit="21"}
                                    {/if}
                                {else}
                                    {if isset($_conf.jrMediaPro_require_images) && $_conf.jrMediaPro_require_images == 'on'}
                                        {jrCore_list module="jrProfile" order_by="_created desc" quota_id=$_conf.jrMediaPro_artist_quota search1="profile_active = 1" search2="profile_jrAudio_item_count > 0" template="index_slider_thumbs.tpl" limit="21" require_image="profile_image"}
                                    {else}
                                        {jrCore_list module="jrProfile" order_by="_created desc" quota_id=$_conf.jrMediaPro_artist_quota search1="profile_active = 1" search2="profile_jrAudio_item_count > 0" template="index_slider_thumbs.tpl" limit="21"}
                                    {/if}
                                {/if}
                            </ul>
                        </div>
