...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrMaestro_breadcrumbs module="jrStore" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
        ...
        <div class="box_body">
            <div class="wrap detail_section">
                ...
                <div class="action_feedback">
                    {jrMaestro_feedback_buttons module="jrStore" item=$item}
