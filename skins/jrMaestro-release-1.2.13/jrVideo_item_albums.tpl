{if !isset($_post._2)}
    ...
    <div class="page_nav clearfix">
        <div class="breadcrumbs">
            ...
            {jrMaestro_breadcrumbs module="jrVideo" profile_url=$profile_url profile_name=$profile_name page="group"}
        </div>
...
{else}
    ...
    {literal}
        ...
        <div class="page_nav clearfix">
            <div class="breadcrumbs">
                {jrCore_include template="profile_header_minimal.tpl"}
                {jrMaestro_breadcrumbs module="jrVideo" profile_url=$_items[0].profile_url page="group" item=$_items[0]}
            </div>
            <div class="action_buttons">
       ...
       <div class="col8">
           <div class="box">
               {jrMaestro_sort template="icons.tpl" nav_mode="jrVideo" profile_url=$_items[0].profile_url}
                   ...
                   <div class="wrap detail_section">
                       ...
                       <div class="detail_box">
                           <div class="header">
                               ...
                               <div style="width:75%;">{jrCore_lang skin="jrMaestro" id=42 default="Title"}</div>
                               <div style="width:15%;">{jrCore_lang skin="jrMaestro" id=43 default="Buy"}</div>
                               <div style="width:5%;">{jrCore_lang skin="jrMaestro" id=44 default="Add"}</div>
                           </div>
                           <div class="media">
                       ...
                       <div class="action_feedback">
                           {jrMaestro_feedback_buttons module="jrVideo" item=$_items.0}
