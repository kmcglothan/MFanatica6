{if !isset($_post._2)}
    ...
    <div class="page_nav clearfix">
        <div class="breadcrumbs">
            ...
            {jrMaestro_breadcrumbs module="jrAudio" profile_url=$profile_url profile_name=$profile_name page="group"}
        </div>
    ...
    <div class="col8">
        <div class="box">
            {jrMaestro_sort template="icons.tpl" nav_mode="jrAudio" profile_url=$profile_url}
    ...
    {literal}
        ...
        <div>
            <div class="page_nav clearfix">
                <div class="breadcrumbs">
                    {jrCore_include template="profile_header_minimal.tpl"}
                    {jrMaestro_breadcrumbs module="jrAudio" profile_url=$_items[0].profile_url profile_name=$_items[0].profile_name page="group" item=$_items[0]}
                </div>
                <div class="action_buttons">
            ...
            <div class="col8">
                <div class="box">
                    {jrMaestro_sort template="icons.tpl" nav_mode="jrAudio" profile_name=$_items[0].profile_name profile_url=$_items[0].profile_url}
                        ...
                        <div class="wrap detail_section">
                            ...
                            <div class="detail_box">
                                <div class="basic-info">
                                    <div class="trigger"><span>{jrCore_lang skin="jrMaestro" id="155" default="Tracks"}</span></div>
                                    <div class="item" style="display: none; padding: 0; margin: 5px auto 0;">
                                        <div style="display: table; width: 100%;">
                                            <div class="header">
                                                <div style="width:5%;">#</div>
                                                <div class="test-left" style="width:75%;">{jrCore_lang skin="jrMaestro" id=42 default="Title"}</div>
                            ...
                            <div class="action_feedback">
                                {jrMaestro_feedback_buttons module="jrAudio" item=$_items.0}
