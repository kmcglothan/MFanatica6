...
{if $_conf.jrMaestro_show_header == 'minimal'}
                ...
                <div class="media">
                    ...
                    {if jrCore_module_is_active("jrFollower")}
                        <div class="profile_data">
                            {jrMaestro_stats assign="action_stats" profile_id=$_profile_id}
                            {jrCore_module_url module="jrFollower" assign="furl"}
                            {jrCore_module_url module="jrAction" assign="murl"}
                            <ul class="clearfix">
                                <li onclick="jrCore_window_location('{$jamroom_url}/{$profile_url}/{$furl}')"><span>{jrCore_lang skin="jrMaestro" id="126" default="Followers"}</span>
                                    {$action_stats.followers}</li>
                                <li onclick="jrCore_window_location('{$jamroom_url}/{$profile_url}/{$furl}/profiles_followed')"><span>{jrCore_lang skin="jrMaestro" id="145" default="Following"}</span>
                                    {$action_stats.following}</li>
                                <li onclick="jrCore_window_location('{$jamroom_url}/{$profile_url}/{$murl}/timeline')"><span>{jrCore_lang skin="jrMaestro" id="144" default="Updates"}</span>
