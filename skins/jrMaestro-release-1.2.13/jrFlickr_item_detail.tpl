...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrMaestro_breadcrumbs module="jrFlickr" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
...
<div class="col8">
    <div class="box">
        {jrMaestro_sort template="icons.tpl" nav_mode="jrFlickr" profile_url=$profile_url}
        <span</span>
        <div class="box_body">
            <div class="wrap detail_section">
                ...
                {if jrUser_is_logged_in()}
                    <div class="action_feedback">
                        {jrMaestro_feedback_buttons module="jrFlickr" item=$item}
