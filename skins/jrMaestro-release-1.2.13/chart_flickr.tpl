...
{if isset($_items)}
    {foreach from=$_items item="item"}
        ...
        {jrMaestro_process_item item=$item module="jrFlick" assign="_item"}
        <div class="list_item">
           <div class="wrap">
               <div class="title">
               ...
               <div class="data clearfix">
                   <span>{$item.flickr_comment_count|jrCore_number_format} {jrCore_lang skin="jrMaestro" id="109" default="Comments"}</span>
                   <span>{$item.flickr_like_count|jrCore_number_format} {jrCore_lang skin="jrMaestro" id="110" default="Likes"}</span>
               </div>
           </div>
        </div>
    {/foreach}
