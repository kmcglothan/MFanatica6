...
{if $info.next_page > 0}
    ...
    <div id="moreHolder{$info.this_page}" class="action">
        <div class="wrap">
            <div class="item center" style="margin:0" onclick="jrMaestro_load_more_timeline('{$info.next_page}','{$info.this_page}');">
                <div class="wrap">
                    ...
                    <a class="moreButton">{jrCore_lang skin="jrMaestro" id=118 default="Load More"}</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="action">
        <div class="wrap">
            <div class="item center" style="margin: 0">
                <div class="wrap">
                    <a id="back_to_top">{jrCore_lang skin="jrMaestro" id=119 default="Back To Top"}</a>
                </div>
            </div>
        </div>
    </div>
