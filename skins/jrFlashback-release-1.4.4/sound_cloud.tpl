                ...
                <div class="container">
                    <div class="row">
                        <div class="col12 last">
                            ...
                            <div class="body_3">
                                {jrCore_list module="jrSoundCloud" order_by=$order_by tpl_dir="jrFlashback" template="sound_cloud_row.tpl" search="soundcloud_title like `$_post._1`%" pagebreak=$_conf.jrFlashback_default_pagebreak page=$_post.p}
                            </div>
                        </div>
                    </div>
                </div>
