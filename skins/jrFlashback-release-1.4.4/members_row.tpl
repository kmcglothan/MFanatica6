    ...
    {/if}
            <div class="col4{if $item@last || ($item@iteration % 3) == 0} last{/if}">
                <div class="center mb10">
                    <a href="{$jamroom_url}/{$item.profile_url}">{jrCore_module_function function="jrImage_display" module="jrProfile" type="profile_image" item_id=$item._profile_id size="medium" crop="auto" class="iloutline" alt=$item.profile_name title=$item.profile_name}</a><br>
