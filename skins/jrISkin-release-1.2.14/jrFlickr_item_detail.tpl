...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrISkin_breadcrumbs module="jrFlickr" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
            ...
            <div class="wrap detail_section">
                ...
                {if jrUser_is_logged_in()}
                    <div class="action_feedback">
                        {jrISkin_feedback_buttons module="jrFlickr" item=$item}
