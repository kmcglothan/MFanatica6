<div class="col4 sidebar">
    ...
    <div class="box">
        {jrISkin_sort template="icons.tpl" nav_mode="stats" profile_url=$profile_url}
        <div class="box_body">
            <div class="wrap">
                <div class="media">
    ...
    {if !jrCore_is_mobile_device() && isset($profile_influences) && strlen($profile_influences) > 0}
        <div class="box">
            {jrISkin_sort template="icons.tpl" nav_mode="star" profile_url=$profile_url}
            <div class="box_body">
                <div class="wrap">
                    <div class="media">
                        {$profile_influences}
    ...
    {if !jrCore_is_mobile_device() && jrCore_module_is_active('jrFollower')}
        ...
        {if strlen($followers) > 0}
            <div class="box">
                {jrISkin_sort template="icons.tpl" nav_mode="jrFollower" profile_url=$profile_url}
                <div class="box_body">
                    <div class="wrap">
                        <div class="media">
                           <div class="wrap clearfix">
    ...
    {if !jrCore_is_mobile_device()}
        ...
        {if strlen($tag_cloud) > 0}
            <div class="box">
                {jrISkin_sort template="icons.tpl" nav_mode="jrTags" profile_url=$profile_url}
                <div class="box_body">
                    <div class="wrap">
                        <div class="media">
                            {$tag_cloud}
