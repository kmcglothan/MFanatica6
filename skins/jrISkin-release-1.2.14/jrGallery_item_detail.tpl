...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrISkin_breadcrumbs module="jrGallery" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
...
<div class="col8">
    <div class="box">
        ...
        <span>{jrCore_lang skin="jrISkin" id="113" default="Images"} by {$item.profile_name}</span>
        <div class="box_body">
