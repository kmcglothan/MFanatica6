        ...
        <ul class="sb-menu">
            ...
            {if !jrUser_is_logged_in()}
                ...
                <li><a href="{$jamroom_url}/{$uurl}/login">
                        {jrCore_lang skin="jrISkin" id="25" default="Login"}
                    </a></li>
            {/if}
            ...
            {if jrUser_is_master()}
                ...
                <li>
                    <a href="{$jamroom_url}/{$core_url}/admin/global">
                        {jrCore_lang skin="jrISkin" id=69 default="Admin Control Panel"}
                    </a>
                    <ul>
                        <li>
            ...
            {elseif jrUser_is_admin()}
                <li>
                    <a href="{$jamroom_url}/{jrCore_module_url module="jrCore"}/dashboard">{jrCore_lang skin="jrISkin" id="17" default="dashboard"}</a>
                </li>
            {/if}
