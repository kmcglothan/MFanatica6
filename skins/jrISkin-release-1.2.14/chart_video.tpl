    ...
    <div class="list_item">
        <div class="wrap clearfix">
            ...
            {else}
                ...
                <div class="data clearfix">
                    <span>{$item.youtube_comment_count|jrCore_number_format} {jrCore_lang skin="jrISkin" id="109" default="Comments"}</span>
                    <span>{$item.youtube_like_count|jrCore_number_format} {jrCore_lang skin="jrISkin" id="110" default="Likes"}</span>
                </div>
            {/if}
        </div>
    </div>
