...
<ul id="actions_tab">
    ...
    {elseif $nav_mode == 'jrPage'}
        <li class="solo"><a href="#" title="{jrCore_lang module="jrPage" id=19 default="Pages"}">
    ...
    {elseif $nav_mode == 'about'}
        <li class="solo"><a href="#" title="{jrCore_lang skin="jrISkin" id="12" default="About"}">
    ...
    {elseif $nav_mode == 'online'}
        <li class="solo"><a href="#" title="{jrCore_lang skin="jrISkin" id="11" default="Online Status"}">
                {jrCore_icon icon="online" size="20" color="444444"}
            </a></li>
     {elseif $nav_mode == 'stats'}
        <li class="solo"><a href="#" title="{jrCore_lang skin="jrISkin" id="13" default="Stats"}">
                {jrCore_icon icon="stats" size="20" color="444444"}
            </a></li>
    ...
    {elseif $nav_mode == 'trending'}
        <li class="solo"><a href="#" title="{jrCore_lang skin="jrISkin" id="146" default="Trending"}">
