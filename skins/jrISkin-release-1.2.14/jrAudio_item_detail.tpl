...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrISkin_breadcrumbs module="jrAudio" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
...
<div class="col8">
    <div class="box">
        {jrISkin_sort template="icons.tpl" nav_mode="jrAudio" profile_url=$profile_url}
        <div class="box_body">
            <div class="wrap detail_section">
                ...
                {elseif $item.audio_file_extension == 'mp3'}
                    {jrCore_media_player module="jrAudio" field="audio_file" item=$item autoplay=$_conf.jrISkin_auto_play}
                {/if}
                <div class="detail_box">
                        ...
                        <div class="item" style="display: none; padding: 0; margin: 5px auto 0;">
                            <div style="display: table; width: 100%;">
                                <div class="header">
                                    ...
                                    <div>{jrCore_lang skin="jrISkin" id=39 default="Genre"}</div>
                    ...
                    {if strlen($item.audio_lyrics) > 0}
                        <div class="lyrics">
                            <div class="trigger"><span>{jrCore_lang skin="jrISkin" id="116" default="Lyrics"}</span></div>
                            <div class="item" style="display: none;">
                                {$item.audio_lyrics}
                            </div>
                        </div>
                ...
                <div class="action_feedback" style="padding: 0">
                    {jrISkin_feedback_buttons module="jrAudio" item=$item}
