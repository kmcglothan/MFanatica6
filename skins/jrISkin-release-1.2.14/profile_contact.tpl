<div class="box">
    {jrISkin_sort template="icons.tpl" nav_mode="contact" profile_url=$profile_url}
    <div class="box_body">
        <div class="wrap">
            <div class="media">
                ...
                <div style="text-align: right; padding: 5px;">
                    ...
                    <img width="24" height="24" alt="working..." src="{$jamroom_url}/{$iurl}/img/skin/jrISkin/submit.gif" id="contact_submit_indicator" style="display: none;">
