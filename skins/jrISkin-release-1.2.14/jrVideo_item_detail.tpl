...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrISkin_breadcrumbs module="jrVideo" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
        ...
        <div class="box_body">
            <div class="wrap detail_section">
                ...
                {elseif $item.video_file_extension == 'm4v'}
                    {jrCore_media_player module="jrVideo" field="video_file" item=$item autoplay=$_conf.jrISkin_auto_play}
                {/if}
                <div class="detail_box">
                    <div class="basic-info">
                        <div class="trigger"><span>{jrCore_lang skin="jrISkin" id="115" default="Basic Info"}</span></div>
                        <div class="item" style="display: none; padding: 0; margin: 5px auto 0;">
                            <div style="display: table; width: 100%;">
                                <div class="header">
                                    <div>{jrCore_lang skin="jrISkin" id=21 default="Album"}</div>
                                    <div>{jrCore_lang skin="jrISkin" id=41 default="Category"}</div>
                                    <div>{jrCore_lang skin="jrISkin" id=40 default="Created"}</div>
                                    <div>{jrCore_lang skin="jrISkin" id=38 default="Plays"}</div>
                                </div>
                                <div class="details">
                    ...
                    {if strlen($item.video_description) > 0}
                        <div class="description">
                            <div class="trigger"><span>{jrCore_lang skin="jrISkin" id="47" default="Description"}</span></div>
                ...
                <div class="action_feedback">
                    {jrISkin_feedback_buttons module="jrVideo" item=$item}
