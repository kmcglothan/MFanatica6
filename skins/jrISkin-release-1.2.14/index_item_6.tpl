...
{if isset($_items)}
    ...
    {foreach from=$_items item="item"}
        {jrISkin_process_item item=$item module=$_conf.jrISkin_list_6_type assign="_item"}
        {if ($n%2) == 1}
...
{else}
    <div class="no-items">
        ...
        <button class="form_button" style="display: block; margin: 2em auto;" onclick="jrCore_window_location('{$jamroom_url}/{$core_url}/skin_admin/global/skin={$_conf.jrCore_active_skin}/section=list+6')">{jrCore_lang skin="jrISkin" id="148" default="Edit Configuration"}</button>
    </div>
{/if}