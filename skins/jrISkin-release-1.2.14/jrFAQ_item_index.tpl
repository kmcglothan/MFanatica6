...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrISkin_breadcrumbs module="jrFAQ" profile_url=$profile_url profile_name=$profile_name page="index"}
    </div>
...
<div class="box">
    {jrISkin_sort template="icons.tpl" nav_mode="jrFAQ" profile_url=$profile_url}
    <div class="box_body">
        <div class="wrap">
