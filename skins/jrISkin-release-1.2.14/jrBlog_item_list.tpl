    ...
    <div class="page_nav clearfix">
        <div class="breadcrumbs">
            ...
            {if strlen($_post._2) > 0}
                {jrISkin_breadcrumbs module="jrBlog" profile_url=$profile_url page="group" item=$_items[0]}
            {else}
                {jrISkin_breadcrumbs module="jrBlog" profile_url=$profile_url page="group"}
            {/if}
        </div>
