...
<div class="action_info">
    ...
    <div class="action_data">
        ...
        {if $item.action_mode == 'create'}
            <span class="action_desc"><a href="{$jamroom_url}/{$item.profile_url}/{$murl}/{$item._item_id}/{$item.vimeo_title_url}">{jrCore_lang module="jrVimeo" id="22" default="Posted a new Vimeo Video"}.</a></span><br>
        ...
        {else}
            <span class="action_desc"><a href="{$jamroom_url}/{$item.profile_url}/{$murl}/{$item._item_id}/{$item.vimeo_title_url}">{jrCore_lang module="jrVimeo" id="43" default="Updated a Vimeo Video"}.</a></span><br>
