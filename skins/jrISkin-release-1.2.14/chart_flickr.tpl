        ...
        <div class="list_item">
           <div class="wrap">
               ...
               <div class="data clearfix">
                   <span>{$item.flickr_comment_count|jrCore_number_format} {jrCore_lang skin="jrISkin" id="109" default="Comments"}</span>
                   <span>{$item.flickr_like_count|jrCore_number_format} {jrCore_lang skin="jrISkin" id="110" default="Likes"}</span>
               </div>
           </div>
        </div>
    {/foreach}
