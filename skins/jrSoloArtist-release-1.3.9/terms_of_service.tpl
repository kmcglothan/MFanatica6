...
{assign var="selected" value="terms"}
{jrCore_lang skin=$_conf.jrCore_active_skin id="83" assign="page_title"}
                    ...
                    <div class="p5">
                        {if jrUser_is_admin()}
                            <div class="block_config">
                                <a href="{$jamroom_url}/page/admin/tools" title="Create your new Terms Of Serivce page">{jrCore_icon icon="gear"}</a>
                            </div>
                        {/if}
                        <h1>{$_conf.jrCore_system_name} {jrCore_lang skin=$_conf.jrCore_active_skin id="83" default="Terms Of Service"}</h1>
                        <div class="breadcrumbs">
                            <a href="{$jamroom_url}/">{jrCore_lang module="jrPage" id="20" default="home"}</a> &raquo; {jrCore_lang skin=$_conf.jrCore_active_skin id="83" default="Terms Of Service"}
                        </div>
                        ...
                        <div class="p20">
                            ...
                            {if jrUser_is_admin()}
                                ...
                                <div class="page_notice error" style="color: #606060;">
                                    ...
                                    <div style="text-align: center; color: #606060;">
                                        <span class="bold" style="color: #FFF;">Note:</span>&nbsp;Make sure to name the new page <span style="color: #FFF;">Terms Of Service</span>.
                                    </div>
                                </div>
                                <br><br>
                            {/if}
