<div id="menu_content">
    <nav id="menu-wrap">
        <ul id="menu">
            ...
            {jrCore_lang skin=$_conf.jrCore_active_skin id="47" default="Cart" assign="ct"}
                <li>
                    <a href="{$_conf.jrFoxyCart_store_domain}/cart?cart=view" title="{$ct}">{jrCore_image image="cart.png" width="24" height="24" alt=$ct}</a>
