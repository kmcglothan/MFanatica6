    ...
    <nav>
        <ul class="sb-menu">
            ...
            {if jrCore_module_is_active('jrSiteBuilder')}
                ...
                {jrSiteBuilder_default_menu title="Band" url="admin" weight="1"}
                {jrSiteBuilder_default_menu title="Blogs" url="blogs" parent="admin" weight="2"}
                {jrSiteBuilder_default_menu title="Gallery" url="admin/gallery" parent="admin" weight="3"}
                {jrSiteBuilder_default_menu title="Event" url="admin/event" weight="4"}
                {jrSiteBuilder_default_menu title="Music" url="music" weight="5"}
                {jrSiteBuilder_default_menu title="SoundCloud" url="admin/soundcloud" parent="music" weight="6"}
                {jrSiteBuilder_default_menu title="Video" url="admin/video" weight="7"}
                {jrSiteBuilder_default_menu title="YouTube" url="admin/youtube" parent="admin/video" weight="8"}
                {jrSiteBuilder_default_menu title="Vimeo" url="admin/vimeo" parent="admin/video" weight="9"}
                {jrSiteBuilder_default_menu title="Our Fans" url="fans" weight="10"}
                {jrSiteBuilder_default_menu title="Contact Us" url="form/contact_us" weight="11"}
            ...
            {else}
                ...
                {elseif jrCore_module_is_active('jrFoxyCart') && strlen($_conf.jrFoxyCart_api_key) > 0}
                    <li>
                        <a href="{$_conf.jrFoxyCart_store_domain}/cart?cart=view">{jrCore_lang  skin=$_conf.jrCore_active_skin id="47" default="cart"}</a>
                ...
                {if jrCore_module_is_active('jrSearch')}
                    <li id="search_link">
                        <a onclick="jrSearch_modal_form();" title="Site Search"><span class="capital">{jrCore_lang  skin=$_conf.jrCore_active_skin id="24" default="search"}</span></a>
                    </li>
                {/if}
