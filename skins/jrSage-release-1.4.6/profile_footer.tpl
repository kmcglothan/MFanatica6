<div class="col3 last">
    <div style="margin-top: 10px;">
        ...
        {if isset($profile_bio) && strlen($profile_bio) > 0}
            <div class="block">
                <div class="title" style="margin-top:5px;">{jrCore_lang skin=$_conf.jrCore_active_skin id="99" default="About"} {$profile_name}</div>
                <div class="block_content">
        ...
        {if isset($profile_influences) && strlen($profile_influences) > 0}
            <div class="block">
                <div class="title"> {jrCore_lang skin=$_conf.jrCore_active_skin id="110" default="Influences"}:</div>
                <div class="block_content">
        ...
        {if jrCore_module_is_active('jrFollower')}
            {jrCore_list module="jrFollower" limit="15" search1="follow_profile_id = `$_profile_id`" search2="follow_active = 1" order_by="_created desc" assign="followers"}
            {if isset($followers) && strlen($followers) > 0}
                <div class="block">
                    <div class="title">
                        <div class="block_config" style="margin-top:0;margin-right:8px;">
                            {jrCore_module_url module="jrFollower" assign="furl"}
                            <span class="info_c normal"><a href="{$jamroom_url}/{$profile_url}/{$furl}">View All</a></span>
                        </div>
                        {jrCore_lang skin=$_conf.jrCore_active_skin id="100" default="Followers"}:</div>
        ...
        {if strlen($rated) > 0}
            <div class="block">
                <div class="title">{jrCore_lang skin=$_conf.jrCore_active_skin id="109" default="Recently Rated"}:</div>
                <div class="block_content center">
                    {$rated}
                </div>
            </div>
        ...
        {if strlen($tag_cloud) > 0}
            <div class="block mb10">
                <div class="title">{jrCore_lang module="jrTags" id="1" default="Profile Tag Cloud"}:</div>
                <div class="block_content">
                    <div class="item">
                        {$tag_cloud}
                    </div>
