                        ...
                        <div class="col12 last">
                            <div class="body_1">
                                ...
                                <div class="body_3">
                                    {if isset($_conf.jrSage_require_images) && $_conf.jrSage_require_images == 'on'}
                                        {if isset($search)}
                                            {jrCore_list module="jrEvent" order_by=$order_by search="`$search`" template="events_row.tpl" require_image="event_image" pagebreak=$_conf.jrSage_default_event_pagebreak page=$_post.p}
                                        {else}
                                            {jrCore_list module="jrEvent" order_by=$order_by template="events_row.tpl" require_image="event_image" pagebreak=$_conf.jrSage_default_event_pagebreak page=$_post.p}
                                        {/if}
                                    {else}
                                        {if isset($search)}
                                            {jrCore_list module="jrEvent" order_by=$order_by search="`$search`" template="events_row.tpl" pagebreak=$_conf.jrSage_default_event_pagebreak page=$_post.p}
                                        {else}
                                            {jrCore_list module="jrEvent" order_by=$order_by template="events_row.tpl" pagebreak=$_conf.jrSage_default_event_pagebreak page=$_post.p}
                                        {/if}
                                    {/if}
                                </div>
                            </div>
