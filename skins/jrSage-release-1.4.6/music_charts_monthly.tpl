                    ...
                    <div class="row">
                        <div class="col12 last">
                            <div class="body_1">
                                ...
                                <div class="body_3">
                                    {if isset($_conf.jrSage_require_images) && $_conf.jrSage_require_images == 'on'}
                                        {jrCore_list module="jrAudio" chart_field="audio_file_stream_count" chart_days="30" tpl_dir="jrSage" template="music_chart_row.tpl" require_image="audio_image" pagebreak=$_conf.jrSage_default_pagebreak page=$_post.p}
                                    {else}
                                        {jrCore_list module="jrAudio" chart_field="audio_file_stream_count" chart_days="30" tpl_dir="jrSage" template="music_chart_row.tpl" pagebreak=$_conf.jrSage_default_pagebreak page=$_post.p}
                                    {/if}
                                </div>
                            </div>
                        </div>
