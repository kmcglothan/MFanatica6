        ...
        <div class="col12 last">
            <div class="block">
                ...
                <div class="block_config">
                    <a href="{$jamroom_url}/{$murl}/feed/{$_conf.jrSoloArtist_main_id}" target="_blank"> {jrCore_image module="jrBlog" image="feed.png" alt="RSS Feed" style="vertical-align: top;"} Subscribe</a>
                </div>
                <div class="title">
