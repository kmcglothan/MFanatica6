...
{jrCore_lang skin=$_conf.jrCore_active_skin id="84" assign="page_title"}
    ...
    {else}
        ...
        <div class="block">
            ...
            <div class="p5">
                ...
                {/if}
                <h1>{$_conf.jrCore_system_name} {jrCore_lang skin=$_conf.jrCore_active_skin id="84" default="Privacy Policy"}</h1>
                <div class="breadcrumbs">
                    <a href="{$jamroom_url}/">{jrCore_lang module="jrPage" id="20" default="home"}</a> &raquo; {jrCore_lang skin=$_conf.jrCore_active_skin id="84" default="Privacy Policy"}
                </div>
                ...
                <div class="p20">
                    ...
                    {if jrUser_is_admin()}
                        ...
                        <div class="page_notice error" style="text-align: left; color: #606060;">
                            ...
                            <div style="text-align: center; color: #606060;">
                                <span class="bold" style="color: #FFF;">Note:</span>&nbsp;Make sure to name the new page <span style="color: #FFF;">Privacy Policy</span>.
                            </div>
                        </div>
                        <br><br>
                    {/if}
                    ...
                    <h3>Contact Us</h3>
                    If you have any questions or concerns about the {$_conf.jrCore_system_name}&nbsp;{jrCore_lang skin=$_conf.jrCore_active_skin id="84"}, please {if jrCore_module_is_active('jrCustomForm')}<a href="{$jamroom_url}/form/contact_us">{else}<a href="{$jamroom_url}/contact_us">{/if}{jrCore_lang skin=$_conf.jrCore_active_skin id="82" default="Contact Us"}</a>
                    <br><br>
