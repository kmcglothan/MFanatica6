...
{jrCore_lang skin=$_conf.jrCore_active_skin id="82" default="Contact Us" assign="page_title"}
    ...
    <div class="row">
        <div class="col12">
            ...
            <div class="block">
                ...
                <h1>{jrCore_lang skin=$_conf.jrCore_active_skin id="82" default="Contact Us"}</h1><br>
                <br>
                <div class="page_note">{jrCore_lang  skin=$_conf.jrCore_active_skin id="85" default="Please enter the message you would like to send"}{jrCore_lang  skin=$_conf.jrCore_active_skin id="86" default=" and we will get back to you ASAP."}</div>
                    ...
                    <div>
                        <form id="jrPrivateNote_new" enctype="multipart/form-data" accept-charset="utf-8" method="post" action="{$jamroom_url}/{$notesurl}/new_save" name="jrPrivateNote_new">
                            ...
                            <div class="left capital bold" style="width:75%;margin:0 auto;">
                                {jrCore_lang skin=$_conf.jrCore_active_skin id="89" default="subject"}:<br><br>
                                <input id="note_subject" class="form_text" type="text" value="" name="note_subject" style="width:100%;">
                            </div>
                            <br><br>
                            <div class="left capital bold" style="width:75%;margin:0 auto;">
                                {jrCore_lang skin=$_conf.jrCore_active_skin id="90" default="message"}:<br><br>
                            ...
                            <div class="center capital bold" style="width:75%;margin:0 auto;">
                                ...
                                &nbsp;<input type="button" value="{jrCore_lang  skin=$_conf.jrCore_active_skin id="87" default="Cancel"}" onclick="jrCore_window_location('{$jamroom_url}');" class="form_button">
                            </div>
                        </form>
                    </div>
                {/if}
