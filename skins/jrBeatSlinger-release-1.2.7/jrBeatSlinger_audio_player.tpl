...
$(document).ready(function(){
    ...
    var autoPlayCookie = jrReadCookie('jrBeatSlinger_audio_autoplay');
    ...
    $('#jp_container_{$uniqid}').bind($.jPlayer.event.volumechange, function(event){
        ...
        jrSetCookie('jrBeatSlinger_audio_volume', jp_volume, 31);
    });

    $('#jp_container_{$uniqid} #jp-auto-play').click(function() {
        jrSetCookie('jrBeatSlinger_audio_autoplay', 0, 31);
        if ($(this).is(':checked')) {
            jrSetCookie('jrBeatSlinger_audio_autoplay', 1, 31);
        }
    });
...
<div class="jrBeatSlinger_player audio" onclick="event.cancelBubble = true; if(event.stopPropagation) event.stopPropagation();">
