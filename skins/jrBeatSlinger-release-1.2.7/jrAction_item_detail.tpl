    ...
    <div class="row" style="overflow:visible;">
        <div class="col8">
            <div class="breadcrumbs">
                ...
                {jrBeatSlinger_breadcrumbs module="jrAction" profile_url=$item.profile_url profile_name=$item.profile_name page="index"}
            </div>
        </div>
        <div class="col4">
            ...
            <div class="action">
                <div class="wrap">
                    ...
                    <div class="action_feedback">
                        {jrBeatSlinger_feedback_buttons module="jrAction" item=$item}
