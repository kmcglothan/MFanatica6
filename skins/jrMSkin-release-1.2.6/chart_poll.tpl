...
{if isset($_items)}
    {foreach $_items as $item}
        ...
        {jrMSkin_process_item item=$item module="jrPoll" assign="_item"}
        <div class="list_item">
           <div class="wrap">
               ...
               <div class="data clearfix">
                   <span>{$item.poll_comment_count|jrCore_number_format} {jrCore_lang skin="jrMSkin" id="109" default="Comments"}</span>
                   <span>{$item.poll_like_count|jrCore_number_format} {jrCore_lang skin="jrMSkin" id="110" default="Likes"}</span>
               </div>
           </div>
        </div>
    {/foreach}
