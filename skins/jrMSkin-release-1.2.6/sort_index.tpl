...
<ul id="actions_tab">
    ...
    {elseif $nav_mode == 'jrBlog'}
        <li id="blog_tab"{$class}>
            <a title="{jrCore_lang skin="jrMSkin" id=23 default="Blog"}"
               href="#"></a>
        </li>
    ...
    {elseif $nav_mode == 'jrFollower'}
        <li id="followers_tab"{$class}>
            <a href="#"
               title="{jrCore_lang skin="jrMSkin" id="15" default="Followers"}"></a>
        </li>
    ...
    {if jrCore_module_is_active('n8Ajax') && $_conf.n8ISkin_sortable == 'on'}
        <li id="new_tab"{$newest}><a href="#" title="{jrCore_lang id=4 skin="jrMSkin" default="By Newest"}"></a></li>
        <li id="alphabet_tab"{$alphabet}><a href="#"
                                            title="{jrCore_lang id=5 skin="jrMSkin" default="Alphabetically"}"></a>
        </li>
        <li id="plays_tab"{$plays}><a href="#" title="{jrCore_lang id=6 skin="jrMSkin" default="By Most Plays"}"></a>
        </li>
        <li id="like_tab"{$likes}><a href="#" title="{jrCore_lang id=7 skin="jrMSkin" default="By Most Likes"}"></a>
        </li>
    {/if}
</ul>