                   ...
                   <div class="col8">
                    ...
                    <span>
                       ...
                       <div class="data clearfix">
                           <span>{$item.event_comment_count|jrCore_number_format} {jrCore_lang skin="jrMSkin" id="109" default="Comments"}</span>
                           <span>{$item.event_like_count|jrCore_number_format} {jrCore_lang skin="jrMSkin" id="110" default="Likes"}</span>
                       </div>
                   </div>
               </div>
            </div>
