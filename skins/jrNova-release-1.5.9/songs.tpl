...
<div class="inner">
    ...
    {if isset($_conf.jrNova_require_images) && $_conf.jrNova_require_images == 'on'}
        ...
        {jrCore_list module="jrAudio" search="audio_active = on" order_by=$order_by template="songs_row.tpl" require_image="audio_image" pagebreak=$_conf.jrNova_default_pagebreak page=$_post.p}

    {else}

        {jrCore_list module="jrAudio" search="audio_active = on" order_by=$order_by template="songs_row.tpl" pagebreak=$_conf.jrNova_default_pagebreak page=$_post.p}
