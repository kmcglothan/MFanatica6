...
<head>{jrCore_lang skin="jrVideoPro" id="1" assign="default_title"}
...
{/foreach}
{/if}
<link rel="stylesheet" href="{jrCore_server_protocol}://fonts.googleapis.com/css?family=Open+Sans:400i,600i,700i,400,600,700" type="text/css">
