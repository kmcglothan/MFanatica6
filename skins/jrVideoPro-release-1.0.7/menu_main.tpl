    ...
    <nav id="menu-wrap">
        <ul id="menu">
            ...
            {if jrCore_module_is_active('jrSearch')}
                {jrCore_lang skin="jrVideoPro" id=10 default="Search" assign="st"}
            ...
            {if jrUser_is_master()}
                ...
                <li class="desk right">
                    <a href="{$jamroom_url}/{$core_url}/admin/global">
                        <img title="{jrCore_lang skin="jrVideoPro" id="29" default="ACP"}" alt="{jrCore_lang skin="jrVideoPro" id="29" default="ACP"}" src="{$jamroom_url}/skins/{$_conf.jrCore_active_skin}/img/acp.png" />
                    </a>
                    <ul>
                        <li>
            ...
            {elseif jrUser_is_admin()}
                <a href="{$jamroom_url}/{jrCore_module_url module="jrCore"}/dashboard">
                    <img title="{jrCore_lang skin="jrVideoPro" id="28" default="dashboard"}" alt="{jrCore_lang skin="jrVideoPro" id="28" default="dashboard"}" src="{$jamroom_url}/skins/{$_conf.jrCore_active_skin}/img/acp.png" />
                </a>
            {/if}
            ...
            {if !jrUser_is_logged_in()}
                ...
                {if $_conf.jrCore_maintenance_mode != 'on' && $_conf.jrUser_signup_on == 'on'}
                    <li class="desk right"><button id="user-create-account" class="form_button" onclick="window.location='{$jamroom_url}/{$uurl}/signup'">
                            {jrCore_lang skin="jrVideoPro" id="7" default="Sign Up"}
                        </button></li>
                {/if}
                <li class="desk right"><a href="{$jamroom_url}/{$uurl}/login" title="{jrCore_lang skin="jrVideoPro" id="3" default="Log In"}">
