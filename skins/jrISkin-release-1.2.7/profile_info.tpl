...
<div class="box">
    {jrISkin_sort template="icons.tpl" nav_mode="about" profile_url=$profile_url}
    <div class="box_body">
            ...
            <div class="item_media">
                <div class="wrap">
                    <div class="profile_information">
                        ...
                        {/if}
                        <span>{jrCore_icon icon="calendar" size="16" color="444444"} {jrCore_lang skin="jrISkin" id=130 default="Joined"} {$_created|jrCore_date_format:"%B %d, %Y"}</span>
                    ...
                    {if strlen($profile_bio) > 0}
                        <div class="wrap">
                            ...
                            {if strlen($profile_bio) > 160}
                                <br>
                                <a class="full_bio" onclick="jrISkin_modal('#bio_modal')">{jrCore_lang skin="jrISkin" id=132 default="Read Full Biography"}</a>
                            {/if}
                            ...
                            <div class="modal" id="bio_modal" style="display: none">
                                <div class="box">
                                    <div class="box_body">
                                        <div class="head">
                                            <div class="wrap">
                                                {jrCore_lang skin="jrISkin" id=131 default="Biography"}
                                            </div>
                                        </div>
                                        <div class="wrap">
                                            <div class="media">
