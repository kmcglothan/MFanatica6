...
{jrCore_lang skin="jrISkin" id=113 default="Store" assign="page_title"}
    ...
    <div class="row">
        <div class="box">
            {if strlen($_post.cat) > 0}
                <div class="head">{jrISkin_cat_title cat=$_post.cat}</div>
            {else}
                <div class="head">{jrCore_lang skin="jrISkin" id="104" default="All Products"}</div>
            {/if}
