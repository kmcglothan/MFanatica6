...
<section id="profile">
    ...
    {if $_conf.jrISkin_show_header == 'minimal' && $profile_disable_header == '1'}
        {* we're not showing the header on profile module pages *}
        {$show = false}
        {if $_conf.jrISkin_show_menu != 'on'}
    ...
    {elseif $profile_disable_header == '1'}
        ...
        {if $_conf.jrISkin_show_header == 'compact'}
            {$crop = "9:1"}
        {/if}
        {if jrCore_is_mobile_device()}
            {$crop = "3:1"}
        ...
        <div id="profile_header">
            <div class="clearfix" style="position: relative;">
                {if $profile_header_image_size > 0}
                    <a href="{$jamroom_url}/{$murl}/image/profile_header_image/{$_profile_id}/1280" data-lightbox="profile_header" title="{jrCore_lang skin="jrISkin" id="34" default="Click to view"}">
                ...
                {else}
                    {if jrCore_is_mobile_device()}
                        {jrCore_image image="profile_header_image_mobile.jpg" width="1140" class="img_scale" height="auto"}
                    {else}
                            ...
                            <div class="col6">
                                <div class="wrap">
                                    <a class="camera" href="{$_conf.jrCore_base_url}/{$murl}/settings/profile_id={$_profile_id}">
                                        ...
                                        {jrCore_lang skin="jrISkin" id="124" default="Update Cover Image"}
                                    </a>
                                </div>
                            </div>
                            <div class="col6">
                    ...
                    <div class="wrap">
                        <div class="profile_image">
                            {if jrProfile_is_profile_owner($_profile_id)}
                                ...
                                {jrCore_lang skin="jrISkin" id="27" default="Change Image" assign="hover"}
                                ...
                                <div class="profile_hoverimage">
                                    <span class="normal">{$hover}</span>&nbsp;{jrCore_item_update_button module="jrProfile" view="settings/profile_id=`$_profile_id`" profile_id=$_profile_id item_id=$_profile_id title="Update Profile" color="ffffff"}
                                </div>
                            {else}
                                {jrCore_module_function
                                function="jrImage_display"
