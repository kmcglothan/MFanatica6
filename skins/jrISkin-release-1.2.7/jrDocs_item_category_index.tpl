...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrISkin_breadcrumbs module="jrDocs" profile_url=$profile_url profile_name=$profile_name page="group" item=$_items[0]}
    </div>
...
<div class="box">
    {jrISkin_sort template="icons.tpl" nav_mode="jrDocs" profile_url=$profile_url}
    <div class="box_body">
        <div class="wrap">
            <div class="media">
                <div class="wrap">
                        ...
                        {/if}
                            <div class="item">
                                ...
                                <form id="doc_search_form" method="get" action="{$jamroom_url}/{$profile_url}/{$murl}/{$category_url}">
                                    ...
                                    <img id="form_submit_indicator" src="{$jamroom_url}/skins/jrISkin/img/submit.gif" width="24" height="24" alt="{jrCore_lang module="jrCore" id="73" default="working..."}"><input type="button" id="doc_search_submit" class="form_button" value="search" tabindex="2" onclick="jrDocs_search_submit();">
                                </form>
                            </div>
                        </div>
