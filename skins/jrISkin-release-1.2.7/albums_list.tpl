            ...
            <div class="wrap clearfix">
                ...
                <div class="col8">
                    ...
                    <div class="data clearfix">
                        <span>{$item.audio_comment_count|jrCore_number_format} {jrCore_lang skin="jrISkin" id="109" default="Comments"}</span>
                        <span>{$item.audio_like_count|jrCore_number_format} {jrCore_lang skin="jrISkin" id="110" default="Likes"}</span>
                    </div>
                </div>
            </div>
        </div>
