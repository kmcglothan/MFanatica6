    ...
    <div id="profile_header">
        <div class="clearfix" style="position: relative;">
            {if $profile_header_image_size > 0}
                <a href="{$jamroom_url}/{$murl}/image/profile_header_image/{$_profile_id}/1280" data-lightbox="profile_header" title="{jrCore_lang skin="jrAudioPro" id=8 default="Click to see full image"}">
                        ...
                        <div class="col6">
                            <div class="wrap">
                                <a class="camera" href="{$_conf.jrCore_base_url}/{$murl}/settings/profile_id={$_profile_id}">
                                    ...
                                    {jrCore_lang skin="jrAudioPro" id=67 default="Update Cover Image"}
                                </a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="table-cell profile-image">
                                <div class="profile_image">
                                    {if jrProfile_is_profile_owner($_profile_id)}
                                        ...
                                        {jrCore_lang skin="jrAudioPro" id=5 default="Edit" assign="hover"}
            ...
            <div class="table">
                <div class="table-row">
                    ...
                    <div class="table-cell" style="width: 20px; white-space: nowrap; padding: 0 10px;">
                        {jrCore_lang id=5 skin="jrAudioPro" default="Follow" assign="Follow"}
                        {jrFollower_button profile_id=$_profile_id title=$follow}
                        {jrCore_lang skin="jrAudioPro" id=5 default="Edit" assign="edit"}
                        ...
                        {if jrUser_is_admin() || jrUser_is_power_user()}
                            {jrCore_lang skin="jrAudioPro" id="6" default="Create Profile" assign="create"}
