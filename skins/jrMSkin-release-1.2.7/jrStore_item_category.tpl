...
{if !isset($_post._2)}
    ...
    <div class="box">
        {jrMSkin_sort template="icons.tpl" nav_mode="jrStore" profile_url=$profile_url}
        <div class="box_body">
            <div class="wrap">
                <div id="list">
...
{else}
    ...
    {literal}
        ...
        <div class="page_nav clearfix">
            <div class="breadcrumbs">
                {jrCore_include template="profile_header_minimal.tpl"}
                {jrMSkin_breadcrumbs module="jrStore" profile_url=$_items[0].profile_url profile_name=$_items[0].profile_name page="group" item=$_items[0]}
            </div>
            <div class="action_buttons">
        ...
        <div class="col8">
            <div class="box">
                {jrMSkin_sort template="icons.tpl" nav_mode="jrStore" profile_url=$_items[0].profile_url}
                <div class="box_body">
                    <div class="wrap">
                        <div id="list">
                                ...
                                <div class="wrap clearfix">
                                    ...
                                    <div class="col8">
                                        ...
                                        <div class="data clearfix">
                                            <span>{$item.product_comment_count|jrCore_number_format} {jrCore_lang skin="jrMSkin" id="109" default="Comments"}</span>
                                            <span>{$item.product_like_count|jrCore_number_format} {jrCore_lang skin="jrMSkin" id="110" default="Likes"}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
