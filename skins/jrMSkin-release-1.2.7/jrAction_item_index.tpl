        ...
        <div class="col8">
            <div class="breadcrumbs">
                ...
                {else}
                    {$apage = 'index'}
                {/if}
                {jrMSkin_breadcrumbs module="jrAction" profile_url=$profile_url profile_name=$profile_name page=$apage}
        ...
        <div id="timeline">
            ...
            {if jrUser_is_linked_to_profile($_profile_id)}
                ...
                {if isset($_post.profile_actions) && $_post.profile_actions == 'mentions'}
                    ...
                    {/if}
                    {jrMSkin_clear_notifications key='jrAction_mentions'}
                ...
                {elseif isset($_post.profile_actions) && $_post.profile_actions == 'feedback'}
                    ...
                    {jrMSkin_clear_notifications key='jrComment_comments'}
                    {jrMSkin_clear_notifications key='jrLike_likes'}
                    {jrMSkin_clear_notifications key='jrLike_dislikes'}
                    {jrMSkin_clear_notifications key='jrRating_ratings'}
