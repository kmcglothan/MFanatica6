        ...
        <div class="wrap clearfix">
            {if strlen($item.video_title) > 0}
                ...
                <div class="data clearfix">
                    <span>{$item.video_comment_count|jrCore_number_format} {jrCore_lang skin="jrMSkin" id="109" default="Comments"}</span>
                    <span>{$item.video_like_count|jrCore_number_format} {jrCore_lang skin="jrMSkin" id="110" default="Likes"}</span>
                </div>
            {elseif strlen($item.vimeo_title) > 0}
                ...
                <div class="data clearfix">
                    <span>{$item.vimeo_comment_count|jrCore_number_format} {jrCore_lang skin="jrMSkin" id="109" default="Comments"}</span>
                    <span>{$item.vimeo_like_count|jrCore_number_format} {jrCore_lang skin="jrMSkin" id="110" default="Likes"}</span>
                </div>
            {else}
