...
{else}
    <div style="text-align:center;">
        <h4>{jrCore_lang skin=$_conf.jrCore_active_skin id="200" default="Sorry, No Users Online!"}<br>{jrCore_lang skin=$_conf.jrCore_active_skin id="201" default="You Can Help Make This Site"}<br>{jrCore_lang skin=$_conf.jrCore_active_skin id="202" default="Active By Logging In!"}</h4><br>
        <br>
        ...
        {if $_conf.jrCore_maintenance_mode != 'on' && $_conf.jrUser_signup_on == 'on'}
            <h4>{jrCore_lang skin=$_conf.jrCore_active_skin id="203" default="OR"}</h4><br>
            <br>
