                ...
                <div class="col3 last">
                    <div id="footer_sn">
                        ...
                        {if strlen($_conf.jrMediaPro_google_name) > 0}
                            <a href="https://plus.google.com/{$_conf.jrMediaPro_google_name}" target="_blank">{jrCore_image image="sn-google-plus.png" width="24" height="24" class="social-img" alt="google+" title="Follow {$_conf.jrMediaPro_google_name} on Google+"}</a>
                        {/if}
