        ...
        <div style="padding: 1.5em 1em 0;">
            <div>
                <div class="head">
                    ...
                    <span>{jrCore_lang skin="kmSuperFans" id=2 default="About"}</span>
                </div>
                <div class="profile_information">
                    {if jrCore_module_is_active("jrFollower")}
                        <div class="profile_data">
                            {kmSuperFans_stats assign="action_stats" profile_id=$_profile_id}
                            ...
                            <ul class="clearfix">
                                <li onclick="jrCore_window_location('{$jamroom_url}/{$purl}/{$furl}')">
                                    <span>{jrCore_lang skin="kmSuperFans" id=35 default="Followers"}</span>
                                    {$action_stats.followers}</li>
                                <li onclick="jrCore_window_location('{$jamroom_url}/{$furl}/following')">
                                    <span>{jrCore_lang skin="kmSuperFans" id=45 default="Following"}</span>
                                    {$action_stats.following}</li>
                                <li onclick="jrCore_window_location('{$jamroom_url}/{$purl}/{$murl}/timeline')">
                                    <span>{jrCore_lang skin="kmSuperFans" id=44 default="Updates"}</span>
                    ...
                    {/if}
                    <span>{jrCore_icon icon="calendar" size="16" color="ff5500"} {jrCore_lang skin="kmSuperFans" id=36 default="Joined"} {$_created|jrCore_date_format:"%B %d, %Y"}</span>
            ...
            {if strlen($profile_bio) > 0}
                <div class="wrap">
                    <div class="head">
                        ...
                        <span>{jrCore_lang skin="kmSuperFans" id=37 default="Biography"}</span>
                    </div>
                    <div class="bio">
                    ...
                    <div class="bio-more">
                        {if strlen($profile_bio) > 160}
                            <a class="full_bio"
                               onclick="kmSuperFans_modal('#bio_modal')">{jrCore_lang skin="kmSuperFans" id=38 default="Read Full Biography"}</a>
                        {/if}
                    </div>
                    <div class="modal" id="bio_modal" style="display: none">
                        <div style="padding: 1em 1em 0">
                            {jrCore_lang skin="kmSuperFans" id=37 default="Biography"}
            ...
            {if strlen($followers) > 0}
                <div class="wrap">
                    <div class="head">
                        ...
                        <span>{$action_stats.followers} {jrCore_lang skin="kmSuperFans" id=35 default="followers"}</span>
                    </div>
                    <div class="followers">
                        {$followers}
                    </div>
                ...
                {if strlen($rated) > 0}
                    <div class="wrap">
                        <div class="head">
                            ...
                            <span>{jrCore_lang skin="kmSuperFans" id="47" default="Rating"}</span>
                        </div>
                        <div class="followers">
                            {$rated}
                        </div>
                ...
                {if strlen($tag_cloud) > 0}
                    <div class="wrap">
                        <div class="head">
                            ...
                            <span>{jrCore_lang skin="kmSuperFans" id="42" default="Tag"}</span>
                        </div>
                        <div class="followers">
                            {$tag_cloud}
                        </div>
