                ...
                <div class="table-row">
                    {if strlen($item.audio_title) > 0}
                        ...
                        <div class="table-cell">
                            <span class="index_title"><a href="{$jamroom_url}/{$item.profile_url}/{$murl}/{$item._item_id}/{$item.audio_title_url}">{$item.audio_title|truncate:40}</a></span>
                        ...
                        <div class="table-cell desk" style="width: 10%; text-align: right">
                            <a href="#" title="{$item.audio_file_stream_count|jrCore_number_format} total plays">{$item.audio_file_stream_count|jrCore_number_format} </a>
                        </div>
                    ...
                    {else}
                        ...
                        <div class="table-cell">
                            <span class="index_title"><a href="{$jamroom_url}/{$item.profile_url}/{$murl}/{$item._item_id}/{$item.soundcloud_title_url}">{$item.soundcloud_title|truncate:40}</a></span>
                        ...
                        <div class="table-cell desk" style="width: 10%; text-align: right">
                            <a href="#" title="{$item.soundcloud_stream_count|jrCore_number_format} total plays">{$item.soundcloud_stream_count|jrCore_number_format} </a>
                        </div>
                        <div class="table-cell large buttons">
                            {jrLike_button item=$item module="jrAudio" action="like"}
                        </div>
