    ...
    <nav>
        <ul class="sb-menu">
            ...
            {if jrCore_module_is_active('jrSearch')}
                {jrCore_lang skin="kmSuperFans" id=36 default="Search" assign="st"}
            ...
            {if jrCore_module_is_active('jrFoxyCart') && strlen($_conf.jrFoxyCart_api_key) > 0}
                <li>
                    {jrCore_lang skin="kmSuperFans" id=35 default="Cart" assign="ct"}
            ...
            {if jrUser_is_master()}
                ...
                <li>
                    <a href="{$jamroom_url}/{$core_url}/admin/global">
                        {jrCore_lang skin="kmSuperFans" id=29 default="Admin Control Panel"}
                    </a>
                    <ul>
                        <li>
            ...
            {elseif jrUser_is_admin()}
                <li>
                    <a href="{$jamroom_url}/{jrCore_module_url module="jrCore"}/dashboard">{jrCore_lang skin="kmSuperFans" id="28" default="dashboard"}</a>
                </li>
            {/if}
