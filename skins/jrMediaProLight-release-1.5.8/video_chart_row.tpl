            ...
            <div class="row">
                ...
                <div class="col8">
                    <div class="p5" style="padding-left:10px;">
                        ...
                        {if isset($item.video_album) && strlen($item.video_album) > 0}<span class="capital bold"> {jrCore_lang skin=$_conf.jrCore_active_skin id="64" default="album"}:</span> <a href="{$jamroom_url}/{$item.profile_url}/{$murl}/albums/{$item.video_album_url}"><span class="capital bold">{$item.video_album}</span></a><br>{else}<br>{/if}
