...
{* EVENT LIST FUNCTION *}
{jrCore_list module="jrBlog" order_by="_created desc" search1="_profile_id = `$_conf.jrMediaProLight_blog_profile`" search2="blog_category = blog" template=$site_blog_template pagebreak="1" page=$_post.p}
