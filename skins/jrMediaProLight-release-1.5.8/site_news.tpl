        ...
        <div class="body_1">
            <h3>
                ...
                <div class="float-right" style="padding-right:10px;">
                    <a onclick="jrCore_window_location('{$jamroom_url}/{$_items.0.profile_url}/{$murl}/{$_items.0._item_id}/{$_items.0.blog_title_url}');">{jrCore_icon icon="gear"}</a>
                </div>
                {/if}
...
{if isset($_conf.jrMediaProLight_blog_profile) && $_conf.jrMediaProLight_blog_profile > 0}
    {jrCore_list module="jrBlog" order_by="_created desc" search1="_profile_id in `$_conf.jrMediaProLight_blog_profile`" search2="blog_category = news" template=$site_news_template pagebreak="1" page=$_post.p}
{else}
