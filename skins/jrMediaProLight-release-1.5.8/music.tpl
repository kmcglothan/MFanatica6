                        ...
                        <div class="col12 last">
                            ...
                            <div class="body_1">
                                ...
                                {if isset($_conf.jrMediaProLight_require_images) && $_conf.jrMediaProLight_require_images == 'on'}
                                    {if isset($_post.search_area) && $_post.search_area == 'audio_genre'}
                                        {jrCore_list module="jrAudio" order_by=$order_by search1="audio_genre like `$_post.search_string`" template="music_row.tpl" require_image="audio_image" pagebreak=$_conf.jrMediaProLight_default_pagebreak page=$_post.p}
                                    {elseif !empty($_post._1)}
                                        {if isset($_post.option) && $_post.option == 'by_album'}
                                            {jrCore_list module="jrAudio" order_by=$order_by group_by="audio_album_url" template="music_row.tpl" require_image="audio_image" search="audio_album like `$_post._1`%" pagebreak=$_conf.jrMediaProLight_default_pagebreak page=$_post.p}
                                        {else}
                                            {jrCore_list module="jrAudio" order_by=$order_by template="music_row.tpl" require_image="audio_image" search="audio_title like `$_post._1`%" pagebreak=$_conf.jrMediaProLight_default_pagebreak page=$_post.p}
                                        {/if}
                                    {else}
                                        {if isset($_post.option) && $_post.option == 'by_album'}
                                            {jrCore_list module="jrAudio" order_by=$order_by group_by="audio_album_url" template="music_row.tpl" require_image="audio_image" pagebreak=$_conf.jrMediaProLight_default_pagebreak page=$_post.p}
                                        {else}
                                            {jrCore_list module="jrAudio" order_by=$order_by template="music_row.tpl" require_image="audio_image" pagebreak=$_conf.jrMediaProLight_default_pagebreak page=$_post.p}
                                        {/if}
                                    {/if}
                                {else}
                                    {if isset($_post.search_area) && $_post.search_area == 'audio_genre'}
                                        {jrCore_list module="jrAudio" order_by=$order_by search1="audio_genre like `$_post.search_string`" template="music_row.tpl" pagebreak=$_conf.jrMediaProLight_default_pagebreak page=$_post.p}
                                    {elseif !empty($_post._1)}
                                        {if isset($_post.option) && $_post.option == 'by_album'}
                                            {jrCore_list module="jrAudio" order_by=$order_by group_by="audio_album_url" template="music_row.tpl" search="audio_album like `$_post._1`%" pagebreak=$_conf.jrMediaProLight_default_pagebreak page=$_post.p}
                                        {else}
                                            {jrCore_list module="jrAudio" order_by=$order_by template="music_row.tpl" search="audio_title like `$_post._1`%" pagebreak=$_conf.jrMediaProLight_default_pagebreak page=$_post.p}
                                        {/if}
                                    {else}
                                        {if isset($_post.option) && $_post.option == 'by_album'}
                                            {jrCore_list module="jrAudio" order_by=$order_by group_by="audio_album_url" template="music_row.tpl" pagebreak=$_conf.jrMediaProLight_default_pagebreak page=$_post.p}
                                        {else}
                                            {jrCore_list module="jrAudio" order_by=$order_by template="music_row.tpl" pagebreak=$_conf.jrMediaProLight_default_pagebreak page=$_post.p}
                                        {/if}
                                    {/if}
                                {/if}
