                ...
                <div class="col3 last">
                    <div id="footer_sn">
                        ...
                        {if strlen($_conf.jrMediaProLight_twitter_name) > 0}
                            {if $_conf.jrMediaProLight_twitter_name|strpos:"https:" !== false}
                                <a href="{$_conf.jrMediaProLight_twitter_name}" target="_blank">{jrCore_image image="sn-twitter.png" width="24" height="24" class="social-img" alt="twitter" title="Follow @{$_conf.jrMediaProLight_twitter_name}"}</a>
                            {else}
                        ...
                        {if strlen($_conf.jrMediaProLight_facebook_name) > 0}
                            {if $_conf.jrMediaProLight_facebook_name|strpos:"https:" !== false}
                                <a href="{$_conf.jrMediaProLight_facebook_name}" target="_blank">{jrCore_image image="sn-facebook.png" width="24" height="24" class="social-img" alt="facebook" title="Like {$_conf.jrMediaProLight_facebook_name} on Facebook"}</a>
                            {else}
                        ...
                        {if strlen($_conf.jrMediaProLight_linkedin_name) > 0}
                            {if $_conf.jrMediaProLight_linkedin_name|strpos:"https:" !== false}
                                <a href="{$_conf.jrMediaProLight_linkedin_name}" target="_blank">{jrCore_image image="sn-linkedin.png" width="24" height="24" class="social-img" alt="linkedin" title="Link up with {$_conf.jrMediaProLight_linkedin_name} on LinkedIn"}</a>
                            {else}
                                <a href="https://linkedin.com/in/{$_conf.jrMediaProLight_linkedin_name}" target="_blank">{jrCore_image image="sn-linkedin.png" width="24" height="24" class="social-img" alt="linkedin" title="Link up with {$_conf.jrMediaProLight_linkedin_name} on LinkedIn"}</a>
                            {/if}
                        {/if}

                        {if strlen($_conf.jrMediaProLight_google_name) > 0}
                            {if $_conf.jrMediaProLight_google_name|strpos:"https:" !== false}
                                <a href="{$_conf.jrMediaProLight_google_name}" target="_blank">{jrCore_image image="sn-google-plus.png" width="24" height="24" class="social-img" alt="google+" title="Follow {$_conf.jrMediaProLight_google_name} on Google+"}</a>
                            {else}
                                <a href="https://plus.google.com/u/0/{$_conf.jrMediaProLight_google_name}" target="_blank">{jrCore_image image="sn-google-plus.png" width="24" height="24" class="social-img" alt="google+" title="Follow {$_conf.jrMediaProLight_google_name} on Google+"}</a>
                            {/if}
                        {/if}

                        {if strlen($_conf.jrMediaProLight_youtube_name) > 0}
                            {if $_conf.jrMediaProLight_youtube_name|strpos:"https:" !== false}
                                <a href="{$_conf.jrMediaProLight_youtube_name}" target="_blank">{jrCore_image image="sn-youtube.png" width="24" height="24" class="social-img" alt="youtube" title="Subscribe to {$_conf.jrMediaProLight_youtube_name} on YouTube"}</a>
                            {else}
                        ...
                        {if strlen($_conf.jrMediaProLight_pinterest_name) > 0}
                            {if $_conf.jrMediaProLight_pinterest_name|strpos:"https:" !== false}
                                <a href="{$_conf.jrMediaProLight_pinterest_name}" target="_blank">{jrCore_image image="sn-pinterest.png" width="24" height="24" class="social-img" alt="pinterest" title="Follow {$_conf.jrMediaProLight_pinterest_name} on Pinterest"}</a>
                            {else}
