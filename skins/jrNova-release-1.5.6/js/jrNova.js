function jrLoad(id,url,round_id,round_num) {
    ...
    if (url == 'blank') {
        ...
        $(id).fadeTo(100,0.5,function() {
            $(id).html('<div style="text-align:center;padding:20px;margin:0 auto;"><img src="'+ core_system_url +'/skins/jrNova/img/inner_submit.gif" style="margin:15px;"><br>Loading...</div>');
