<div style="text-align:right;padding:12px;">
    ...
    <a onclick="jrLoad('#sc','{$jamroom_url}/song_chart_monthly');"><span class="media_title" style="color:#F7DD4F;">{jrCore_lang  skin=$_conf.jrCore_active_skin id="33" default="Monthly"}</span></a>&nbsp;|
