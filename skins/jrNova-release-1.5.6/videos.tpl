...
<div class="inner">
    ...
    {if isset($_conf.jrNova_require_images) && $_conf.jrNova_require_images == 'on'}
        ...
        {jrCore_list module="jrVideo" order_by=$order_by pagebreak=$_conf.jrNova_default_pagebreak template="videos_row.tpl" require_image="video_image" page=$_post.p}

    {else}

        {jrCore_list module="jrVideo" order_by=$order_by pagebreak=$_conf.jrNova_default_pagebreak template="videos_row.tpl" page=$_post.p}
