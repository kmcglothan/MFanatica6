...
<section id="profile">
    ...
    {if $_conf.jrMaestro_show_header == 'minimal' && $profile_disable_header == '1'}
        {* we're not showing the header on profile module pages *}
        {$show = false}
        {if $_conf.jrMaestro_show_menu != 'on'}
    ...
    {elseif $profile_disable_header == '1'}
        ...
        {if $_conf.jrMaestro_show_header == 'compact'}
            {$crop = "9:1"}
        {/if}
        {if jrCore_is_mobile_device()}
            {$crop = "3:1"}
        ...
        <div id="profile_header">
            <div class="clearfix" style="position: relative;">
                {if $profile_header_image_size > 0}
                    <a href="{$jamroom_url}/{$murl}/image/profile_header_image/{$_profile_id}/1280" data-lightbox="profile_header" title="{jrCore_lang skin="jrMaestro" id="34" default="Click to view"}">
                            ...
                            <div class="col6">
                                <div class="wrap">
                                    <a class="camera" href="{$_conf.jrCore_base_url}/{$murl}/settings/profile_id={$_profile_id}">
                                        ...
                                        {jrCore_lang skin="jrMaestro" id="124" default="Update Cover Image"}
                                    </a>
                                </div>
                            </div>
                            <div class="col6">
                    ...
                    <div class="wrap">
                        <div class="profile_image">
                            {if jrProfile_is_profile_owner($_profile_id)}
                                ...
                                {jrCore_lang skin="jrMaestro" id="27" default="Change Image" assign="hover"}
                ...
                <div class="table">
                    <div class="table-row">
                        ...
                        <div class="table-cell" style="width: 20px; white-space: nowrap; padding: 0 10px;">
                            {if jrUser_is_logged_in()}
                                {if !jrUser_is_linked_to_profile($_profile_id)}
                                    ...
                                    {if jrCore_module_is_active('jrAction')}
                                        <a title="Mention This Profile" onclick="jrMaestro_modal('#mention_modal','@{$profile_url}')">{jrCore_icon icon="mention" size="22" class="email"}</a>
                            ...
                            {jrCore_lang id=24 skin="jrMaestro" default="Follow" assign="follow"}
