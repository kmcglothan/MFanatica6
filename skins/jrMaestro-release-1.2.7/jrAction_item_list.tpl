                ...
                <div class="wrap">
                    <div class="action_info">
                        ...
                        <div class="action_data">
                            ...
                            {jrCore_lang skin="jrMaestro" id="117" default="shared"} <span class="action_user_name"><a>{$item.action_original_data.profile_url}'s</a></span>
                    ...
                    <div class="action_feedback">
                        {jrMaestro_feedback_buttons module="jrAction" item=$item timeline=true disable_share=true}
                    </div>
                </div>
            </div>
        ...
        {elseif $item.action_module == 'jrAction' && isset($item.action_text)}
            ...
            <div class="action">
                <div class="wrap">
                    ...
                    <div class="action_feedback">
                        {jrMaestro_feedback_buttons module="jrAction" item=$item timeline=true}
                    </div>
                </div>
            </div>
        ...
        {elseif isset($item.action_html)}
            ...
            <div class="action">
                ...
                <div class="wrap">
                    ...
                    <div class="action_feedback">
                        {jrMaestro_feedback_buttons module=$item.action_module item_id=$item.action_item_id item=$item timeline=true}
                    </div>
                </div>
