...
<div class="block">
    ...
    <div class="title">
        <div class="block_config">
            {jrCore_item_detail_buttons module="jrForum" field="forum_file" item=$topic forum_user_is_following=$forum_user_is_following delete_action="`$murl`/post_delete_save/id=`$topic._item_id`"}
        </div>
        <h1>
