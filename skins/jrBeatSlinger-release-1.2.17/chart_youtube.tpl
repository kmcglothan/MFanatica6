        ...
        <div class="list_item">
            <div class="wrap clearfix">
                ...
                <div class="data clearfix">
                    <span>{$item.youtube_comment_count|jrCore_number_format} {jrCore_lang skin="jrBeatSlinger" id="109" default="Comments"}</span>
                    <span>{$item.youtube_like_count|jrCore_number_format} {jrCore_lang skin="jrBeatSlinger" id="110" default="Likes"}</span>
                </div>
            </div>
        </div>
    {/foreach}
