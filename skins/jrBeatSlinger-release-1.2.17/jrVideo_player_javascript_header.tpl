<script type="text/javascript">
    $(document).ready(function() {
        ...
        var autoPlayCookie = jrReadCookie('jrBeatSlinger_video_autoplay');
        ...
        $('#jp_container_{$uniqid} #jp-auto-play').click(function() {
            jrSetCookie('jrBeatSlinger_video_autoplay', 0, 31);

            if ($(this).is(':checked')) {
                jrSetCookie('jrBeatSlinger_video_autoplay', 1, 31);
            }
        });
        $('#jp_container_{$uniqid} #jp-auto-mute').click(function() {
            jrSetCookie('jrBeatSlinger_auto_mute', 0, 31);
            if ($(this).is(':checked')) {
                jrSetCookie('jrBeatSlinger_auto_mute', 1, 31);
            }
        });
    });
</script>