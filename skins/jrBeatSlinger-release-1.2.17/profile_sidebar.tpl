<div class="col4 sidebar">
    ...
    {if !jrCore_is_mobile_device() && isset($profile_influences) && strlen($profile_influences) > 0}
        <div class="box">
            {jrBeatSlinger_sort template="icons.tpl" nav_mode="star" profile_url=$profile_url}
            <div class="box_body">
                <div class="wrap">
                    <div class="media">
                        {$profile_influences}
    ...
    {if !jrCore_is_mobile_device()}
        ...
        {if strlen($tag_cloud) > 0}
            <div class="box">
                {jrBeatSlinger_sort template="icons.tpl" nav_mode="jrTags" profile_url=$profile_url}
                <div class="box_body">
                    <div class="wrap">
                        <div class="media">
                            {$tag_cloud}
