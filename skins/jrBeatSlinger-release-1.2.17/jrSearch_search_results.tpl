...
<div class="container search_results_container">
    <div class="row">
        <div class="col12 last">
            <div class="box">
                {jrBeatSlinger_sort template="icons.tpl" nav_mode="jrSearch"}
                <div class="box_body">
                    <div class="wrap">
                        <div class="media">
                            <div class="wrap">
                                ...
                                <form method="get"
                                    ...
                                    <span style="display:inline-block;margin-top:8px;"><img id="form_submit_indicator"
                                                                                            src="{$jamroom_url}/skins/jrBeatSlinger/img/submit.gif"
                                                                                            width="24" height="24"
                            ...
                            <div class="row">
                                <div class="col12 last">
                                    <div class="box">
                                        ...
                                        {jrBeatSlinger_sort template="icons.tpl" nav_mode=$module}
