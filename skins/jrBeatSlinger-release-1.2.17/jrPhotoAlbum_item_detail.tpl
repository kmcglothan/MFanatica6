...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrBeatSlinger_breadcrumbs module="jrPhotoAlbum" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
...
<div class="box">
    {jrBeatSlinger_sort template="icons.tpl" nav_mode="jrPhotoAlbum" profile_url=$profile_url}
    <div class="box_body">
        <div class="wrap detail_section">
            ...
            <div class="action_feedback">
                {jrBeatSlinger_feedback_buttons module="jrPhotoAlbum" item=$item}
                {if jrCore_module_is_active('jrRating')}
                    <div class="rating" id="jrPhotoAlbum_{$item._item_id}_rating">{jrCore_module_function
                        function="jrRating_form"
                        type="star"
                        module="jrPhotoAlbum"
                        index="1"
                        item_id=$item._item_id
                        current=$item.photoalbum_rating_1_average_count|default:0
                        votes=$item.photoalbum_rating_1_number|default:0}</div>
                {/if}
