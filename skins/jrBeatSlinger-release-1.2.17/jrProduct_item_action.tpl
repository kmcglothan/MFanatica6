...
<div class="item_media">
    <div class="wrap clearfix">
        ...
        <div class="media_text">
               ...
               <p>
                   {$item.action_data.product_description|jrCore_strip_html|truncate:400}
                   {if strlen($item.action_data.product_description) > 400}
            ...
            <span id="full_product_{$item.action_item_id}" style="display: none;"><p>
                    {$item.action_data.product_description|jrCore_strip_html}
