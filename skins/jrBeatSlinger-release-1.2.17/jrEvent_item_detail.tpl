...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrBeatSlinger_breadcrumbs module="jrEvent" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
        ...
        <div class="box_body">
            <div class="wrap detail_section">
                ...
                <div class="action_feedback">
                    {jrBeatSlinger_feedback_buttons module="jrEvent" item=$item}
