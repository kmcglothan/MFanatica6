...
{* TOP ARTISTS/SITE NEWS/TOP SONGS *}
    <div class="row">
        ...
        {* SITE NEWS *}
        <div class="col6">
        {if isset($_conf.jrNovaLight_site_news_ids) && $_conf.jrNovaLight_site_news_ids > 0}
            {jrCore_list module="jrBlog" order_by="blog_display_order numerical_asc" search1="blog_category = site news" search2="_profile_id in `$_conf.jrNovaLight_site_news_ids`" limit="2" template="index_site_news.tpl" assign="SITENEWS"}
        {else}
...
{* ONLINE/ARTICLES/SPONSORS *}
    <div class="row">
        ...
        {* SITE ARTICLES *}
        <div class="{if $_conf.jrNovaLight_ads_off != 'on'}col6{else}col9 last{/if}">
            <div class="mb8">
                <div class="inner leader mb8{if $_conf.jrNovaLight_ads_off != 'on'} mr8{/if}">
                ...
                <div class="finner mb8{if $_conf.jrNovaLight_ads_off != 'on'} mr8{/if}">
        ...
        <div class="col3 last">
            ...
            <div class="finner mb8 center">
                <div class="p10">
                    ...
                    {elseif isset($_conf.jrNovaLight_bottom_ad) && strlen($_conf.jrNovaLight_bottom_ad) > 0}
                        {$_conf.jrNovaLight_bottom_ad}
                    {else}
...
{* COMMUNITY RADIO AND TV *}
    <div class="row">
        ...
        {* COMMUNITY RADIO *}
        <div class="col6">
        {if isset($_conf.jrNovaLight_show_radio) && $_conf.jrNovaLight_show_radio == 'on'}
            <div class="inner mb8 mr8">
                <div id="cr">
                    {if isset($_conf.jrNovaLight_radio_title) && strlen($_conf.jrNovaLight_radio_title) > 0}
                        {jrCore_list module="jrPlaylist" order_by="_created desc" search1="playlist_title = `$_conf.jrNovaLight_radio_title`" search2="_profile_id = 1" template="index_radio.tpl"}
                    {else}
                        {if jrUser_is_logged_in()}
                            {if jrUser_is_master()}
                                <div class="media_title p20">
                                    Admin Note:&nbsp;<a href="{$jamroom_url}/core/skin_admin/global/skin=jrNovaLight"><span style="color:#FFF;text-decoration:underline;">Settings</span></a> <b>"Radio Title"</b> is not set!
                                </div>
                            {/if}
                        {/if}
                    {/if}
        ...
        {* COMMUNITY TV *}
        <div class="col6 last">
        {if isset($_conf.jrNovaLight_show_tv) && $_conf.jrNovaLight_show_tv == 'on'}
            <div class="inner mb8">
                <div id="ctv">
                    {if isset($_conf.jrNovaLight_tv_title) && strlen($_conf.jrNovaLight_tv_title) > 0}
                        {jrCore_list module="jrPlaylist" order_by="_created desc" search1="playlist_title = `$_conf.jrNovaLight_tv_title`" search2="_profile_id = 1" template="index_channel.tpl"}
                    {else}
                        {if jrUser_is_logged_in()}
                            {if jrUser_is_master()}
                                <div class="media_title p20">
                                    Admin Note:&nbsp;<a href="{$jamroom_url}/core/skin_admin/global/skin=jrNovaLight"><span style="color:#FFF;text-decoration:underline;">Settings</span></a> <b>"TV Title"</b> is not set!
                                </div>
                            {/if}
                        {/if}
                    {/if}
...
{* SITE WIDE TAG CLOUD *}
    ...
    {if strlen($tag_cloud) > 0}
        <div class="row">
            <div class="col12 last">
                <div class="inner leader mb8">Tag Cloud</div>
...
{* SITE STATS *}
    {if isset($_conf.jrNovaLight_show_stats) && $_conf.jrNovaLight_show_stats == 'on'}
        <div class="row">
            <div class="col12 last">
                <div class="inner">
                    <div class="inner leader" style="background-color: #FFF; border-color: transparent;">
