...
{jrCore_list module="jrPage" search="page_location = 0" order_by="_created desc" tpl_dir="jrNovaLight" template="index_content.tpl" pagebreak=$_conf.jrNovaLight_default_pagebreak page=$_post.p}
