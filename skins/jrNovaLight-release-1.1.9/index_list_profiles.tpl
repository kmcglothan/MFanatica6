...
<div class="center p10">
    <input type="button" value="{jrCore_lang module="jrNovaLight" id="41" default="more"} {jrCore_lang module="jrNovaLight" id="31" default="top"} {jrCore_lang module="jrNovaLight" id="12" default="artists"}" class="form_button" onclick="jrLoad('#top_artists','{$info.page_base_url}/p={$info.next_page}');$('html, body').animate({ scrollTop: $('#tartists').offset().top -100 }, 'slow');">
</div>
{elseif $info.page >= 2}
<div class="block">
