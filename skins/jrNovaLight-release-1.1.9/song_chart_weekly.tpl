<div style="text-align:right;padding:12px;">
    <a onclick="jrLoad('#sc','{$jamroom_url}/song_chart_weekly');"><span class="_media_title" style="color:#999999;">{jrCore_lang  skin=$_conf.jrCore_active_skin id="32" default="Weekly"}</span></a>&nbsp;|
