        ...
        <div class="col3">
            ...
            {/if}
                ...
                {if jrCore_module_is_active('jrFollower')}
                    ...
                    {/literal}
                    {/capture}
                    {jrCore_list module="jrFollower" search1="follow_profile_id = `$_profile_id`" search2="follow_active = 1" order_by="_created desc" template=$follower_row assign="followers"}
            ...
            {/if}
                ...
                <div class="block mb10">
                    <div class="block_content">
                        <h3>{jrCore_lang  skin=$_conf.jrCore_active_skin id="42" default="stats"}:</h3><br>
                ...
                {if strlen($tag_cloud) > 0}
                    <div class="block mb10">
                        <div class="block_content mt10">
                            ...
                            <div style="background-color:#BBBBBB;border-radius:4px;box-shadow:inset 0 0 2px #999999;">
                                {$tag_cloud}
                            </div>
                            <div class="clear"></div>
                        </div>
