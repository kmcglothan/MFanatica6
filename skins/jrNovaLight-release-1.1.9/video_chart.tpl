...
<div class="inner">
    <div id="vc">
        <div style="text-align:right;padding:12px;">
            <a onclick="jrLoad('#vc','{$jamroom_url}/video_chart_weekly');"><span class="media_title" style="color:#999999;">{jrCore_lang  skin=$_conf.jrCore_active_skin id="32" default="Weekly"}</span></a>&nbsp;|
