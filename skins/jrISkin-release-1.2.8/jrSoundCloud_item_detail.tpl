...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrISkin_breadcrumbs module="jrSoundCloud" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
...
<div class="col8">
    <div class="box">
        {jrISkin_sort template="icons.tpl" nav_mode="jrSoundCloud" profile_url=$profile_url}
        <div class="box_body">
            <div class="wrap detail_section">
                {jrSoundCloud_embed item_id=$item._item_id auto_play=$_conf.jrISkin_auto_play}
                    ...
                    <div class="basic-info">
                        ...
                        <div class="item" style="display: none; padding: 0;">
                            <div style="display: table; width: 100%">
                                <div class="header">
                                    <div>{jrCore_lang skin="jrISkin" id=46 default="Artist"}</div>
                ...
                <div class="action_feedback">
                    {jrISkin_feedback_buttons module="jrSoundCloud" item=$item}
