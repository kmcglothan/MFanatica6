<script type="text/javascript">
    $(document).ready(function() {
        ...
        var autoPlayCookie = jrReadCookie('jrISkin_video_autoplay');
        var volumeCookie = jrReadCookie('jrISkin_audio_volume');
        var muteCookie = jrReadCookie('jrISkin_auto_mute');
        ...
        $('#jp_container_{$uniqid} #jp-auto-play').click(function() {
            jrSetCookie('jrISkin_video_autoplay', 0, 31);

            if ($(this).is(':checked')) {
                jrSetCookie('jrISkin_video_autoplay', 1, 31);
            }
        });
        $('#jp_container_{$uniqid} #jp-auto-mute').click(function() {
            jrSetCookie('jrISkin_auto_mute', 0, 31);
            if ($(this).is(':checked')) {
                jrSetCookie('jrISkin_auto_mute', 1, 31);
            }
        });
    });
</script>