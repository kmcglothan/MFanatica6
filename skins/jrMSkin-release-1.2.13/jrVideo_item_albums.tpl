{if !isset($_post._2)}
    ...
    <div class="page_nav clearfix">
        <div class="breadcrumbs">
            ...
            {jrMSkin_breadcrumbs module="jrVideo" profile_url=$profile_url profile_name=$profile_name page="group"}
        </div>
    ...
    <div class="col8">
        <div class="box">
            ...
            <span>{jrCore_lang module="jrVideo" id="34" default="Albums"} by {$profile_name}</span>
            <div class="box_body">
                <div class="wrap">
...
{else}
    ...
    {literal}
        ...
        <div class="page_nav clearfix">
            <div class="breadcrumbs">
                {jrCore_include template="profile_header_minimal.tpl"}
                {jrMSkin_breadcrumbs module="jrVideo" profile_url=$_items[0].profile_url page="group" item=$_items[0]}
            </div>
            <div class="action_buttons">
       ...
       <div class="col8">
           <div class="box">
               {jrMSkin_sort template="icons.tpl" nav_mode="jrVideo" profile_url=$_items[0].profile_url}
                   ...
                   <div class="wrap detail_section">
                       ...
                       <div class="detail_box">
                           <div class="header">
                               ...
                               <div style="width:75%;">{jrCore_lang skin="jrMSkin" id=42 default="Title"}</div>
                               <div style="width:15%;">{jrCore_lang skin="jrMSkin" id=43 default="Buy"}</div>
                               <div style="width:5%;">{jrCore_lang skin="jrMSkin" id=44 default="Add"}</div>
                           </div>
                           <div class="media">
                       ...
                       <div class="action_feedback">
                           {jrMSkin_feedback_buttons module="jrVideo" item=$_items.0}
                           {if jrCore_module_is_active('jrRating')}
                           <div class="rating" id="jrVideo_{$item._items.0}_rating">{jrCore_module_function
