...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrMSkin_breadcrumbs module="jrGuestBook" profile_url=$profile_url profile_name=$profile_name page="detail"}
    </div>
...
<div class="box">
    {jrMSkin_sort template="icons.tpl" nav_mode="jrGuestBook" profile_url=$profile_url}
    <div class="box_body">
        <div class="wrap">
