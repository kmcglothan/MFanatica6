...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrMSkin_breadcrumbs module="jrPlaylist" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
...
<div class="col8">
    <div class="box">
        {jrMSkin_sort template="icons.tpl" nav_mode="jrPlaylist" profile_url=$profile_url}
        <div class="box_body">
            <div class="wrap detail_section">
                ...
                <div class="action_feedback">
                    {jrMSkin_feedback_buttons module="jrPlaylist" item=$item}
