...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrMSkin_breadcrumbs module="jrVimeo" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
    ...
    <div class="box">
        ...
        <div class="box_body">
            <div class="wrap detail_section">
                {jrVimeo_embed type="iframe" item_id=$item._item_id auto_play=$_conf.jrMSkin_auto_play width="100%"}
                ...
                <div class="action_feedback">
                    {jrMSkin_feedback_buttons module="jrVimeo" item=$item}
