...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrMSkin_breadcrumbs module="jrGroup" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
...
<div class="row">
    <div class="col9">
        <div class="box">
            {jrMSkin_sort template="icons.tpl" nav_mode="jrGroup" profile_url=$profile_url}
            <div class="box_body">
                    ...
                    <div class="action_feedback" style="padding: 0">
                        {if jrGroup_member_has_access($item)}
                            {if !jrCore_module_is_active('jrComment') || !isset($item.group_wall) || $item.group_wall == 'off'}
                                {jrMSkin_feedback_buttons module="jrGroup" comment=false item=$item}
                            ...
                            {else}
                                {jrMSkin_feedback_buttons module="jrGroup" item=$item}
                                {if jrCore_module_is_active('jrRating')}
                                    <div class="rating" id="jrGroup_{$item._item_id}_rating">{jrCore_module_function
                                        function="jrRating_form"
                                        type="star"
