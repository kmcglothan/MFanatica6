...
<div class="page_nav">
    <div class="breadcrumbs">
        ...
        {jrMSkin_breadcrumbs module="jrBlog" profile_url=$item.profile_url page="detail" item=$item}
    </div>
...
<div class="col8">
    <div class="box">
        {jrMSkin_sort template="icons.tpl" nav_mode="jrBlog" profile_url=$profile_url}
        <div class="box_body">
            <div class="wrap detail_section">
                <div class="media">
                    <div class="wrap clearfix">
                        ...
                        <div class="author clearfix">
                            ...
                            {jrCore_lang skin="jrMSkin" id="107" default="follow this author" assign="ft"}
                        ...
                        <br>
                        {if strlen($_conf.jrMSkin_featured_story_ids) > 0}
                            <h2>{jrCore_lang skin="jrMSkin" id="120" default="Recommended"}</h2>
                            <div class="recommended">
                                {jrCore_list module="jrBlog" search="_item_id in `$_conf.jrMSkin_featured_story_ids`" order_by="_created RANDOM" limit="4" template="blog_recommend.tpl"}
                            </div>
                        {/if}
                    </div>
                </div>
                ...
                <div class="action_feedback">
                    {jrMSkin_feedback_buttons module="jrBlog" item=$item}
