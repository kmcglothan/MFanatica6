...
function jrMSkin_init()
{
    ...
    setTimeout(jrMSkin_check_pulse, 1000);
    setInterval(jrMSkin_check_pulse, 30000);
    ...
    jrMSkin_collect();  // fire first collection on page load
    $(window).resize(jrMSkin_collect); // fire collection on window resize

    function jrMSkin_collect()
    {
        menu.css({
            visibility: 'collapse',
 ...
 */
function jrMSkin_open_div(div, f)
{
 ...
 * @returns {boolean}
 */
function jrMSkin_reply_to(item_id, user_name, div)
{
 ...
 * @param profile_url
 */
function jrMSkin_modal(id, profile_url)
{
    $(id).modal();
    if (profile_url) {
 ...
 */
function jrMSkin_watch_timeline()
{
 ...
 * @returns {boolean}
 */
function jrMSkin_load_more_timeline(next_page, this_page)
{
