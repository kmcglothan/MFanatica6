...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrMSkin_breadcrumbs module="jrGroupDiscuss" profile_url=$profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
...
<div class="box">
    {jrMSkin_sort template="icons.tpl" nav_mode="jrGroupDiscuss" profile_url=$profile_url}
    <div class="box_body">
            ...
            <div id="list">
                ...
                <div class="action_feedback" style="padding:0">
                    {if jrGroup_member_has_access($item)}
                        {jrMSkin_feedback_buttons module="jrGroupDiscuss" item=$item}
