...
{if $_conf.jrMSkin_bio_right == 'on'}
    <div class="page_nav">
        <div class="breadcrumbs">
            {jrCore_include template="profile_header_minimal.tpl"}
            {jrMSkin_breadcrumbs module="jrAction" profile_url=$profile_url page="index"}
        </div>
        <div class="action_buttons">
            {jrCore_lang id=25 skin="jrMSkin" default="Follow" assign="follow"}
...
<div class="box">
    {jrMSkin_sort template="icons.tpl" nav_mode="bio" profile_url=$profile_url}
    <div class="box_body">
        <div class="wrap">
            <div class="media">
                <div class="wrap">
