...
<div class="media">
    {if $item.action_mode == 'create_album'}
        ...
        limit="24"
        type="jrMSkin_video_action_player"
        autoplay=false}
    {else}
        {jrCore_media_player type="jrMSkin_video_action_player" module="jrVideo" field="video_file" item_id=$item.action_item_id autoplay=false}
    {/if}
</div>
