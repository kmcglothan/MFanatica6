...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrCelebrity_breadcrumbs module="jrSoundCloud" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
    ...
    <div class="box">
        ...
        <div class="box_body">
            <div class="wrap detail_section">
                {jrSoundCloud_embed item_id=$item._item_id auto_play=$_conf.jrCelebrity_auto_play}
                    ...
                    <div class="basic-info">
                        ...
                        <div class="item" style="display: none; padding: 0;">
                            <div style="display: table; width: 100%">
                                <div class="header">
                                    <div>{jrCore_lang skin="jrCelebrity" id=46 default="Artist"}</div>
                ...
                <div class="action_feedback">
                    {jrCelebrity_feedback_buttons module="jrSoundCloud" item=$item}
