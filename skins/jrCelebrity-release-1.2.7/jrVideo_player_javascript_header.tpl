<script type="text/javascript">
    $(document).ready(function() {
        ...
        var autoPlayCookie = jrReadCookie('jrCelebrity_video_autoplay');
        var volumeCookie = jrReadCookie('jrCelebrity_audio_volume');
        var muteCookie = jrReadCookie('jrCelebrity_auto_mute');
        ...
        $('#jp_container_{$uniqid} #jp-auto-play').click(function() {
            jrSetCookie('jrCelebrity_video_autoplay', 0, 31);

            if ($(this).is(':checked')) {
                jrSetCookie('jrCelebrity_video_autoplay', 1, 31);
            }
        });
        $('#jp_container_{$uniqid} #jp-auto-mute').click(function() {
            jrSetCookie('jrCelebrity_auto_mute', 0, 31);
            if ($(this).is(':checked')) {
                jrSetCookie('jrCelebrity_auto_mute', 1, 31);
            }
        });
    });
</script>