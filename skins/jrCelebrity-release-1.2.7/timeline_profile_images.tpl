    ...
    <div class="media">
        ...
        {if jrCore_module_is_active("jrFollower")}
            <div class="profile_data">
                {jrCelebrity_stats assign="action_stats" profile_id=$profile._profile_id}
                {jrCore_module_url module="jrFollower" assign="furl"}
                {jrCore_module_url module="jrAction" assign="murl"}
                <ul class="clearfix">
                    <li onclick="jrCore_window_location('{$jamroom_url}/{$profile.profile_url}/{$furl}')"><span>{jrCore_lang skin="jrCelebrity" id="126" default="Followers"}</span>
                    ...
                    <li onclick="jrCore_window_location('{$jamroom_url}/{$profile.profile_url}/{$murl}/timeline')"><span>{jrCore_lang skin="jrCelebrity" id="144" default="Updates"}</span>
