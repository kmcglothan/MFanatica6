...
{if $_conf.jrCelebrity_bio_right == 'on'}
    <div class="page_nav">
        <div class="breadcrumbs">
            {jrCore_include template="profile_header_minimal.tpl"}
            {jrCelebrity_breadcrumbs module="jrAction" profile_url=$profile_url page="index"}
        </div>
        <div class="action_buttons">
            {jrCore_lang id=25 skin="jrCelebrity" default="Follow" assign="follow"}
...
<div class="box">
    {jrCelebrity_sort template="icons.tpl" nav_mode="bio" profile_url=$profile_url}
    <div class="box_body">
        <div class="wrap">
            <div class="media">
                <div class="wrap">
