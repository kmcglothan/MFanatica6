...
<div class="box">
    {jrCelebrity_sort template="icons.tpl" nav_mode="about" profile_url=$profile_url}
    <div class="box_body">
            ...
            <div class="item_media">
                <div class="wrap">
                    <div class="profile_information">
                        ...
                        {/if}
                        <span>{jrCore_icon icon="calendar" size="16" color="D2B48C"} {jrCore_lang skin="jrCelebrity" id=130 default="Joined"} {$_created|jrCore_date_format:"%B %d, %Y"}</span>
                            ...
                            <div class="modal" id="bio_modal" style="display: none">
                                <div class="box">
                                    <div class="box_body">
                                        <div class="head">
                                            <div class="wrap">
                                                {jrCore_lang skin="jrCelebrity" id=131 default="Biography"}
                                            </div>
                                        </div>
                                        <div class="wrap">
                                            <div class="media">
