...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {jrCelebrity_breadcrumbs module="jrFollower" profile_url=$profile_url profile_name=$profile_name page="index"}
    </div>
...
{if jrUser_is_logged_in()}
    {if jrUser_is_linked_to_profile($_profile_id)}
        {jrCelebrity_clear_notifications key='jrFollower_followers'}
    {/if}
