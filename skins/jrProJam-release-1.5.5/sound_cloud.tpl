                    ...
                    <div class="row">
                        <div class="col12 last">
                            ...
                            {/foreach}
                                ...
                                {jrCore_list module="jrSoundCloud" order_by=$order_by template="sound_cloud_row.tpl" search="soundcloud_title like `$_post._1`%" pagebreak=$_conf.jrProJam_default_pagebreak page=$_post.p}
                            </div>
                        </div>
                    </div>
                </div>
