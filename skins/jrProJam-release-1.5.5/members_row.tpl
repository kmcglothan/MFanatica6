    ...
    {/if}
            <div class="col3{if $item@last || ($item@iteration % 4) == 0} last{/if}">
                <div class="center mb10">
                    ...
                    <a href="{$jamroom_url}/{$item.profile_url}" title="{$item.profile_name}"><span class="capital bold">{if strlen($item.profile_name) > 15}{$item.profile_name|truncate:15:"...":false}{else}{$item.profile_name}{/if}</span></a><br>
