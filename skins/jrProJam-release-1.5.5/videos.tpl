                    ...
                    <div class="row">
                        <div class="col12 last">
                            ...
                            {if isset($_conf.jrProJam_require_images) && $_conf.jrProJam_require_images == 'on'}
                                {if isset($_post.search_area) && $_post.search_area == 'video_category'}
                                    {jrCore_list module="jrVideo" order_by=$order_by tpl_dir="jrProJam" template="videos_row.tpl" search="video_category like `$_post.search_string`" require_image="video_image" pagebreak=$_conf.jrProJam_default_pagebreak page=$_post.p}
                                {elseif !empty($_post._1)}
                                    {jrCore_list module="jrVideo" order_by=$order_by tpl_dir="jrProJam" template="videos_row.tpl" search="video_title like `$_post._1`%" require_image="video_image" pagebreak=$_conf.jrProJam_default_pagebreak page=$_post.p}
                                {else}
                                    {jrCore_list module="jrVideo" order_by=$order_by tpl_dir="jrProJam" template="videos_row.tpl" require_image="video_image" pagebreak=$_conf.jrProJam_default_pagebreak page=$_post.p}
                                {/if}
                            {else}
                                {if isset($_post.search_area) && $_post.search_area == 'video_category'}
                                    {jrCore_list module="jrVideo" order_by=$order_by tpl_dir="jrProJam" template="videos_row.tpl" search="video_category like `$_post.search_string`" pagebreak=$_conf.jrProJam_default_pagebreak page=$_post.p}
                                {elseif !empty($_post._1)}
                                    {jrCore_list module="jrVideo" order_by=$order_by tpl_dir="jrProJam" template="videos_row.tpl" search="video_title like `$_post._1`%" pagebreak=$_conf.jrProJam_default_pagebreak page=$_post.p}
                                {else}
                                    {jrCore_list module="jrVideo" order_by=$order_by tpl_dir="jrProJam" template="videos_row.tpl" pagebreak=$_conf.jrProJam_default_pagebreak page=$_post.p}
                                {/if}
                            {/if}
                            </div>
                        </div>
