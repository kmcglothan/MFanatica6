            ...
            <div class="row">
                ...
                <div class="col8">
                    <div class="p5 middle">
                        ...
                        <span class="capital">{jrCore_lang module="jrSoundCloud" id="26" default="artist"}:</span> <a href=""><span class="capital">{$item.soundcloud_artist}</span></a><br>
                        ...
                        {/if}
                        <span class="capital">{jrCore_lang module="jrSoundCloud" id="27" default="genre"}:</span> <span class="hilite">{$item.soundcloud_genre}</span><br>
