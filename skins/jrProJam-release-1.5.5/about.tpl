            ...
            <div style="padding:10px;">
                ...
                <div class="br-info" style="margin-bottom:20px;">
                    ...
                    <div class="float-right">
                        <a onclick="window.location='{$jamroom_url}/{$_user.profile_url}/blog'">{jrCore_icon icon="gear"}</a>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="blog-text">
                    Click the button with the gear image to create an about blog, be sure to set the category to about so it shows here.
                </div>
                {else}
                <div class="br-info" style="margin-bottom:20px;">
                    <h3>About Us</h3>
