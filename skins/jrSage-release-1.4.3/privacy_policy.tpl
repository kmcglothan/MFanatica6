...
{jrCore_lang skin=$_conf.jrCore_active_skin id="80" default="Privacy Policy" assign="page_title"}
        ...
        <div class="body_1">
            ...
            {else}
                ...
                <div class="title">
                    ...
                    {/if}
                    <h2>{$_conf.jrCore_system_name} {jrCore_lang skin=$_conf.jrCore_active_skin id="80" default="Privacy Policy"}</h2>
                    <div class="breadcrumbs">
                        <a href="{$jamroom_url}/">{jrCore_lang module="jrPage" id="20" default="home"}</a> &raquo; {jrCore_lang skin=$_conf.jrCore_active_skin id="80" default="Privacy Policy"}
                    </div>
                </div>
