    ...
    <nav>
        <ul class="sb-menu">
            ...
            {else}
                ...
                <li><a href="{$jamroom_url}"{if isset($selected) && $selected == 'home'} style="color:#408140;"{/if}>{jrCore_lang skin=$_conf.jrCore_active_skin id="1" default="home"}</a></li>
                <li>
                    ...
                    {/if}
                    <a href="{$jamroom_url}/community"{if isset($selected) && $selected == 'community' || (isset($_post._uri) && $_post._uri == $forum_uri) || (isset($_post._uri) && $_post._uri == $doc_uri)} style="color:#408140;"{/if}>{jrCore_lang skin=$_conf.jrCore_active_skin id="26" default="community"}</a>
                    <ul>
                ...
                {if jrCore_module_is_active('jrCharts')}
                    <li>
                        <a href="{$jamroom_url}/music_charts"{if isset($selected) && $selected == 'charts'} style="color:#408140;"{/if}>{jrCore_lang skin=$_conf.jrCore_active_skin id="27" default="charts"}</a>
                        <ul>
                            <li>
                ...
                {/if}
                <li>
                    <a href="{$jamroom_url}/artists"{if isset($selected) && $selected == 'lists'} style="color:#408140;"{/if}>{jrCore_lang skin=$_conf.jrCore_active_skin id="28" default="lists"}</a>
                    <ul>
                        <li>
                ...
                <li><a href="{$jamroom_url}/galleries"{if isset($selected) && $selected == 'galleries'} style="color:#408140;"{/if}>{jrCore_lang skin=$_conf.jrCore_active_skin id="29" default="galleries"}</a></li>
                <li>
                    <a href="{$jamroom_url}/events"{if isset($selected) && $selected == 'events'} style="color:#408140;"{/if}>{jrCore_lang skin=$_conf.jrCore_active_skin id="30" default="events"}</a>
                    <ul>
                ...
                <li><a href="{$jamroom_url}/articles"{if isset($selected) && $selected == 'articles'} style="color:#408140;"{/if}>{jrCore_lang skin=$_conf.jrCore_active_skin id="67" default="articles"}</a></li>
            ...
            {if jrUser_is_logged_in()}
                {if jrUser_is_master()}
                    ...
                    {/if}
                    <li>
                        <a href="{$jamroom_url}/{$core_url}/admin/global"{if !isset($from_profile) && !isset($selected) && $acp_menu_item == 'yes'} style="color:#408140;"{/if}>{jrCore_lang skin=$_conf.jrCore_active_skin id="16" default="ACP"}</a>
                        <ul>
                            <li>
                ...
                {elseif jrUser_is_admin()}
                    ...
                    {else}
                        {assign var="acp_menu_item" value="yes"}
                    {/if}
                    <li><a href="{$jamroom_url}/{jrCore_module_url module="jrCore"}/dashboard"{if !isset($from_profile) && !isset($selected) && $acp_menu_item == 'yes'} style="color:#408140;"{/if}>{jrCore_lang skin=$_conf.jrCore_active_skin id="17" default="dashboard"}</a></li>
                {/if}
            {else}
                {if $_conf.jrCore_maintenance_mode != 'on' && $_conf.jrUser_signup_on == 'on'}
                    <li><a href="{$jamroom_url}/{jrCore_module_url module="jrUser"}/signup"{if isset($_post._uri) && $_post._uri == '/user/signup'} style="color:#408140;"{/if}>{jrCore_lang skin=$_conf.jrCore_active_skin id="2" default="create"}&nbsp;{jrCore_lang skin=$_conf.jrCore_active_skin id="3" default="account"}</a></li>
                {/if}
                <li><a href="{$jamroom_url}/{jrCore_module_url module="jrUser"}/login"{if isset($_post._uri) && $_post._uri == '/user/login'} style="color:#408140;"{/if}>{jrCore_lang skin=$_conf.jrCore_active_skin id="6" default="login"}</a></li>
            {/if}
            ...
            {if jrUser_is_logged_in()}
                ...
                {/if}
                <li>
                    <a href="{$jamroom_url}/{jrUser_home_profile_key key="profile_url"}"{if isset($artist_menu_item) && $artist_menu_item == 'yes'} style="color:#408140;"{/if}>{jrUser_home_profile_key key="profile_name"}</a>
                    <ul>
            ...
            {if jrCore_module_is_active('jrFoxyCart') && strlen($_conf.jrFoxyCart_api_key) > 0}
                <li>
                    <a href="{$_conf.jrFoxyCart_store_domain}/cart?cart=view">{jrCore_lang skin=$_conf.jrCore_active_skin id="125" default="My Cart"}<span id="fc_minicart"><span id="fc_quantity"></span></span></a>
                </li>
            {/if}
