...
{jrCore_lang skin=$_conf.jrCore_active_skin id="79" default="Terms Of Service" assign="page_title"}
            ...
            {else}
                ...
                <div class="title">
                    {if jrUser_is_admin()}
                        <div class="block_config">
                            <a onclick="jrCore_window_location('{$jamroom_url}/page/admin/tools');" title="update" href="{$jamroom_url}/page/admin/tools">{jrCore_icon icon="gear" size="16"}</a>
                        </div>
                    {/if}
                    <h1>{$_conf.jrCore_system_name} {jrCore_lang skin=$_conf.jrCore_active_skin id="79" default="Terms Of Service"}</h1>
                    <div class="breadcrumbs">
                        <a href="{$jamroom_url}/">{jrCore_lang module="jrPage" id="20" default="home"}</a> &raquo; {jrCore_lang skin=$_conf.jrCore_active_skin id="79" default="Terms Of Service"}
                    </div>
                </div>
                ...
                <div class="body_3">
                    ...
                    <div class="p20">
                        ...
                        will be processed within the expected time frame. We will not have any liability to you
