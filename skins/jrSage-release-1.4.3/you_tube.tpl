                    ...
                    <div class="row">
                        <div class="col12 last">
                            <div class="body_1">
                                ...
                                <div class="body_3">
                                    {jrCore_list module="jrYouTube" order_by=$order_by template="you_tube_row.tpl" search="youtube_title like `$_post._1`%" pagebreak=$_conf.jrSage_default_pagebreak page=$_post.p}
                                </div>
                            </div>
                        </div>
                    </div>
