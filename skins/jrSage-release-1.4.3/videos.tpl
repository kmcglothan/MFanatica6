                    ...
                    <div class="row">
                        <div class="col12 last">
                            <div class="body_1">
                                ...
                                <div class="body_3">
                                    {if isset($_conf.jrSage_require_images) && $_conf.jrSage_require_images == 'on'}
                                        {jrCore_list module="jrVideo" order_by=$order_by tpl_dir="jrSage" template="videos_row.tpl" search="video_title like `$_post._1`%" require_image="video_image" pagebreak=$_conf.jrSage_default_pagebreak page=$_post.p}
                                    {else}
                                        {jrCore_list module="jrVideo" order_by=$order_by tpl_dir="jrSage" template="videos_row.tpl" search="video_title like `$_post._1`%" pagebreak=$_conf.jrSage_default_pagebreak page=$_post.p}
                                    {/if}
                                </div>
                            </div>
                        </div>
