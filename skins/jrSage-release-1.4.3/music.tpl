                    ...
                    <div class="row">
                        <div class="col12 last">
                            <div class="body_1">
                                ...
                                <div class="body_3">
                                    {if isset($_conf.jrSage_require_images) && $_conf.jrSage_require_images == 'on'}
                                        {jrCore_list module="jrAudio" order_by=$order_by tpl_dir="jrSage" template="music_row.tpl" require_image="audio_image" search="audio_title like `$_post._1`%" pagebreak=$_conf.jrSage_default_pagebreak page=$_post.p}
                                    {else}
                                        {jrCore_list module="jrAudio" order_by=$order_by tpl_dir="jrSage" template="music_row.tpl" search="audio_title like `$_post._1`%" pagebreak=$_conf.jrSage_default_pagebreak page=$_post.p}
                                    {/if}
                                </div>
                            </div>
                        </div>
