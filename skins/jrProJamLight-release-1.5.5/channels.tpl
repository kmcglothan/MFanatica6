                    ...
                    <div class="row">
                        <div class="col12 last">
                            ...
                            <div class="body_3 mb20">
                                ...
                                {elseif isset($_conf.jrProJamLight_tv_title) && strlen($_conf.jrProJamLight_tv_title) > 0}
                                    {jrCore_list module="jrPlaylist" order_by="_created desc" search1="playlist_list like %jrVideo%" search2="playlist_title = `$_conf.jrProJamLight_tv_title`" limit="1" template="channels_playlist.tpl" autoplay=$cap}
                                {else}
