                ...
                <div class="container">
                    <div class="row">
                        <div class="col12 last">
                            ...
                            <div class="body_3">
                                {jrCore_list module="jrPage" order_by="_created desc" tpl_dir="jrProJamLight" template="articles_row.tpl" pagebreak=$_conf.jrProJamLight_default_articles_pagebreak page=$_post.p}
                            </div>
                        </div>
                    </div>
                </div>
