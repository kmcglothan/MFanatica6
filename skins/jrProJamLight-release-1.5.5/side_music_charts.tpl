...
<table class="menu_tab">
    <tr>
        {if isset($_post.search_area) && $_post.search_area == 'audio_genre'}
            ...
            <td class="spacer">&nbsp;</td>
            <td>
                <div id="default" class="p_choice" onclick="jrLoad('#stats','{$jamroom_url}/music_chart_genres{if isset($period) && strlen($period) >0}/{$period}{/if}');jrSetActive('#default');">{jrCore_lang skin=$_conf.jrCore_active_skin id="167" default="Genres"}</div>
            </td>
        {else}
            <td>
            ...
            <td class="spacer">&nbsp;</td>
            <td>
                <div id="genre_search" class="p_choice" onclick="jrLoad('#stats','{$jamroom_url}/music_chart_genres{if isset($period) && strlen($period) >0}/{$period}{/if}');jrSetActive('#genre_search');">{jrCore_lang skin=$_conf.jrCore_active_skin id="167" default="Genres"}</div>
            </td>
        {/if}
    </tr>
</table>
        ...
        {else}
            {if jrUser_is_logged_in()}
                {if jrUser_is_master()}
                    ...
                    <div class="body_3 mb20">
                        Admin Note:&nbsp;<a href="{$jamroom_url}/core/skin_admin/global/skin=jrProJamLight">Settings</a> <b>"Channel Title"</b> is not set!
                    </div>
                {/if}
            {/if}
        {/if}
...
{* OUR SPONSORS *}
{if $_conf.jrProJamLight_ads_off != 'on'}
