...
<div class="outer mb8">
    ...
    <div id="footer_sn">
        ...
        {if strlen($_conf.jrNovaLight_linkedin_name) > 0}
            <a href="https://linkedin.com/{$_conf.jrNovaLight_linkedin_name}" target="_blank">{jrCore_image image="sn-linkedin.png" width="24" height="24" class="social-img" alt="linkedin" title="Link up with {$_conf.jrNovaLight_linkedin_name} on LinkedIn"}</a>
        {/if}

        {if strlen($_conf.jrNovaLight_google_name) > 0}
            <a href="https://plus.google.com/{$_conf.jrNovaLight_google_name}" target="_blank">{jrCore_image image="sn-google-plus.png" width="24" height="24" class="social-img" alt="google+" title="Follow {$_conf.jrNovaLight_google_name} on Google+"}</a>
        {/if}
