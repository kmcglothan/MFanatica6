                    ...
                    <div class="row">
                        <div class="col12 last">
                            ...
                            {/foreach}
                                ...
                                {jrCore_list module="jrVimeo" order_by=$order_by template="vimeo_videos_row.tpl" search="vimeo_title like `$_post._1`%" pagebreak=$_conf.jrProJam_default_pagebreak page=$_post.p}
                            </div>
                        </div>
                    </div>
                </div>
