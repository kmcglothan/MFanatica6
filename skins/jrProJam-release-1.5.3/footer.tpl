                ...
                <div class="col3 last">
                    <div id="footer_sn">
                        ...
                        {if strlen($_conf.jrProJam_linkedin_name) > 0}
                            <a href="https://linkedin.com/{$_conf.jrProJam_linkedin_name}" target="_blank">{jrCore_image image="sn-linkedin.png" width="24" height="24" class="social-img" alt="linkedin" title="Link up with {$_conf.jrProJam_linkedin_name} on LinkedIn"}</a>
                        {/if}

                        {if strlen($_conf.jrProJam_google_name) > 0}
                            <a href="https://plus.google.com/{$_conf.jrProJam_google_name}" target="_blank">{jrCore_image image="sn-google-plus.png" width="24" height="24" class="social-img" alt="google+" title="Follow {$_conf.jrProJam_google_name} on Google+"}</a>
                        {/if}
