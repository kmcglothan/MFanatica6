            ...
            <tr>
                ...
                <td class="body_5 page" style="width:25%;text-align:center;">
                    {if isset($info.prev_page) && $info.prev_page > 0}
                        <a onclick="jrLoad('#top_station_div','{$jamroom_url}/top_stations_list/p={$info.prev_page}');$('html, body').animate({ scrollTop: $('#tstations').offset().top -100 }, 'slow');"><span class="button-arrow-previous">&nbsp;</span></a>
                    {else}
                ...
                <td class="body_5" style="width:50%;text-align:center;">
                    {if $info.total_pages <= 5 || $info.total_pages > 500}
                        ...
                        <form name="form" method="post" action="_self">
                            <select name="pagenum" class="form_select" style="width:60px;" onchange="var sel=this.form.pagenum.options[this.form.pagenum.selectedIndex].value;jrLoad('#top_station_div','{$jamroom_url}/top_stations_list/p=' +sel);$('html, body').animate({ scrollTop: $('#tstations').offset().top -100 }, 'slow');">
                ...
                <td class="body_5 page" style="width:25%;text-align:center;">
                    {if isset($info.next_page) && $info.next_page > 1}
                        <a onclick="jrLoad('#top_station_div','{$jamroom_url}/top_stations_list/p={$info.next_page}');$('html, body').animate({ scrollTop: $('#tstations').offset().top -100 }, 'slow');"><span class="button-arrow-next">&nbsp;</span></a>
                    {else}
