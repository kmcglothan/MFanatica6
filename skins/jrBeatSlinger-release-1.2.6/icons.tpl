...
<ul id="actions_tab">
            ...
            {if jrCore_module_is_active('jrCombinedAudio') && $item.quota_jrCombinedAudio_allowed == 'on'}
                <a title="{jrCore_lang module="jrCombinedAudio" id=1 default="Audio"}"
                   href="{$jamroom_url}/{$item.profile_url}/{jrCore_module_url module="jrCombinedAudio"}">
                    {jrCore_icon icon="audio" size="20" color="000000"}
                </a>
            {else}
            ...
            {if jrCore_module_is_active('jrCombinedVideo') && $item.quota_jrCombinedVideo_allowed == 'on'}
                <a title="{jrCore_lang module="jrCombinedVideo" id=1 default="Video"}"
                   href="{$jamroom_url}/{$item.profile_url}/{jrCore_module_url module="jrCombinedVideo"}">
                    {jrCore_icon icon="video" size="20" color="000000"}
                </a>
            {else}
    ...
    {elseif $nav_mode == 'jrVimeo'}
        <li class="solo">
            {if jrCore_module_is_active('jrCombinedVideo') && $item.quota_jrCombinedVideo_allowed == 'on'}
                <a title="{jrCore_lang module="jrCombinedVideo" id=1 default="Video"}"
                   href="{$jamroom_url}/{$item.profile_url}/{jrCore_module_url module="jrCombinedVideo"}">{jrCore_icon icon="video" size="20" color="000000"}</a>
            {else}
                <a title="{jrCore_lang module="jrVimeo" id=38 default="Vimeo"}"
                   href="#">{jrCore_icon icon="video" size="20" color="000000"}</a>
            {/if}
        </li>
    {elseif $nav_mode == 'jrBlog'}
        <li class="solo">
            <a title="{jrCore_lang skin="jrPost" id=23 default="Blog"}"
               href="#">{jrCore_icon icon="blog" size="20" color="000000"}</a>
        </li>
            ...
            <li class="solo">
                <a href="{$jamroom_url}/{$profile_url}/{$nav_murl}"
                   title="{jrCore_lang module="jrAction" id="4" default="Timeline"}">
                    {jrCore_icon icon="home" size="20" color="000000"}
                </a>
            </li>
        {else}
            <li>
            ...
            <li>
                <a href="{$jamroom_url}/{$profile_url}/{$nav_murl}/mentions"
                   title="{jrCore_lang module="jrAction" id="7" default="Mentions"}">
                    {jrCore_icon icon="mention" size="20" color="000000"}
                </a>
            </li>
        {/if}
        ...
        <li class="solo">
            <a href="#"
               title="{jrCore_lang skin="jrPost" id="15" default="Followers"}">
                {jrCore_icon icon="followers" size="20" color="000000"}
            </a>
        </li>
    {elseif $nav_mode == 'jrEvent'}
        <li class="solo"><a href="#" title="{jrCore_lang module="jrEvent" id=31 default="Event"}">
                {jrCore_icon icon="calendar" size="20" color="000000"}
            </a></li>
    {elseif $nav_mode == 'jrPage'}
        <li class="solo"><a href="#" title="{jrCore_lang module="jrEvent" id=31 default="Event"}">
                {jrCore_icon icon="page" size="20" color="000000"}
            </a></li>
    ...
    {elseif $nav_mode == 'jrGallery'}
        <li class="solo"><a href="#"
                ...
                {jrCore_icon icon="gallery" size="20" color="000000"}
            </a>
        </li>
    {elseif $nav_mode == 'jrStore'}
       ...
       {if $single == true}
           <li class="solo"><a href="#" title="{jrCore_lang module="jrStore" id="19" default="Products"}">
                   {jrCore_icon icon="store" size="20" color="000000"}
               </a></li>
       {else}
    ...
    {elseif $nav_mode == 'jrGroup'}
        <li class="solo"><a href="#" title="{jrCore_lang module="jrGroup" id="1" default="Groups"}">
                {jrCore_icon icon="group" size="20" color="000000"}
            </a></li>
    ...
    {elseif $nav_mode == 'about'}
        <li class="solo"><a href="#" title="{jrCore_lang skin="jrBeatSlinger" id="12" default="About"}">
                {jrCore_icon icon="info" size="20" color="000000"}
            </a></li>
    {elseif $nav_mode == 'contact'}
        <li class="solo"><a href="#" title="{jrCore_lang skin="jrBeatSlinger" id="12" default="About"}">
                {jrCore_icon icon="mail" size="20" color="000000"}
            </a></li>
    {elseif $nav_mode == 'bio'}
        <li class="solo"><a href="#" title="{jrCore_lang skin="jrBeatSlinger" id="12" default="About"}">
                {jrCore_icon icon="bio" size="20" color="000000"}
            </a></li>
    {elseif $nav_mode == 'online'}
        <li class="solo"><a href="#" title="{jrCore_lang skin="jrBeatSlinger" id="11" default="Online Status"}">
                {jrCore_icon icon="online" size="20" color="000000"}
            </a></li>
     {elseif $nav_mode == 'stats'}
        <li class="solo"><a href="#" title="{jrCore_lang skin="jrBeatSlinger" id="13" default="Stats"}">
                {jrCore_icon icon="stats" size="20" color="000000"}
            </a></li>
    {elseif $nav_mode == 'menu'}
        <li class="solo"><a href="#" title="{jrCore_lang skin="jrBeatSlinger" id="13" default="Stats"}">
                {jrCore_icon icon="menu" size="20" color="000000"}
            </a></li>
    {elseif $nav_mode == 'trending'}
        <li class="solo"><a href="#" title="{jrCore_lang skin="jrBeatSlinger" id="146" default="Trending"}">
                {jrCore_icon icon="trending" size="20" color="000000"}
            </a></li>
    {else}
        <li class="solo"><a href="#" title="{$title}">
                {jrCore_icon icon="star" size="20" color="000000"}
            </a></li>
    {/if}
