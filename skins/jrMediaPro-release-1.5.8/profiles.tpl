                            ...
                            <div class="col12 last">
                                ...
                                <div id="profiles" class="mb20">
                                    {if isset($_conf.jrMediaPro_admin_quota) && $_conf.jrMediaPro_admin_quota != $_conf.jrMediaPro_artist_quota}
                                        {jrCore_list module="jrProfile" order_by="profile_name asc" group_by="profile_quota_id" search="profile_quota_id != `$_conf.jrMediaPro_admin_quota`" template="profiles_row.tpl" pagebreak="3" page=$_post.p pager=true}
                                    {else}
