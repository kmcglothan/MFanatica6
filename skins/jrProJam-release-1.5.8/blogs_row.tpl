...
{if isset($_items)}
    ...
    <div class="body_5 page" style="padding:5px; margin-bottom:5px; margin-right:10px;">
        ...
        <div style="font-size:11px;">
            <span class="highlight-txt"><i>{jrCore_lang skin=$_conf.jrCore_active_skin id="112" default="By"}:</i></span>&nbsp;<a href="{if $item.profile_id == '1'}{$jamroom_url}{else}{$item.profile_url}{/if}"><span class="capital">{$item.profile_name}</span></a>&nbsp;&nbsp;<span class="highlight-txt"><i>{jrCore_lang skin=$_conf.jrCore_active_skin id="129" default="Tag"}:</i></span>&nbsp;<span class="capital">{$item.blog_category}</span><br>
