                    ...
                    <div class="row">
                        <div class="col12 last">
                            ...
                            <div class="body_3 mb20">
                                ...
                                {elseif isset($_conf.jrProJam_radio_title) && strlen($_conf.jrProJam_radio_title) > 0}
                                    {jrCore_list module="jrPlaylist" order_by="_created desc" search1="playlist_list like %jrAudio%" search2="playlist_title = `$_conf.jrProJam_radio_title`" limit="1" template="station_playlist.tpl" autoplay=$sap}
                                {else}
                                    {jrCore_list module="jrPlaylist" order_by="_item_id random" search1="playlist_list like %jrAudio%" limit="1" template="station_playlist.tpl" autoplay=$sap}
                                {/if}
