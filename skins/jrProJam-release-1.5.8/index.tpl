...
{* EVENTS CALENDAR *}
    <div class="col4 last">
        ...
        {* EVENT LIST FUNCTION *}
        {jrCore_list module="jrEvent" order_by="event_date NUMERICAL_ASC" limit="5" search="event_date >= `$smarty.now`" template=$index_event_template}
        </div>
    </div>
                            ...
                            <table style="width:100%;">
                                <tr>
                                    ...
                                    <td class="body_5" style="width:50%;text-align:center;">
                                        {if $info.total_pages <= 1 || $info.total_pages > 20}
